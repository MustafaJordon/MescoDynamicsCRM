...
function SL_UnApproveInvoice_BindTableRows(pSL_Invoices) {
    ...
    ClearAllTableRows("tblSL_UnApproveDbtCrdtNotes");
    $.each(pSL_Invoices, function (i, item) {
        debugger;

        //editControlsText = " class='btn btn-xs btn-rounded btn-info float-right' > <i class='fa fa-pencil' style='padding-left: 5px;'></i> <span style='padding-right: 5px;'>" + TranslateString("Edit") + "</span>";
        AppendRowtoTable("tblSL_UnApproveDbtCrdtNotes",
    ...
    ApplyPermissions();
    BindAllCheckboxonTable("tblSL_UnApproveDbtCrdtNotes", "ID");
    CheckAllCheckbox("ID");
    HighlightText("#tblSL_UnApproveDbtCrdtNotes>tbody>tr", $("#txt-Search").val().trim());
...
function SL_UnApproveInvoice_Approve() {
    ...
    console.log(GetAllSelectedIDsAsString("tblSL_UnApproveDbtCrdtNotes"));
    var pSelectedIDs = GetAllSelectedIDsAsString("tblSL_UnApproveDbtCrdtNotes");
    if (pSelectedIDs != "") {
