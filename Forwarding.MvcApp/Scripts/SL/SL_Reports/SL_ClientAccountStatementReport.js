...
function TrialBalance_Print(pOutputTo) {
    ...
    var pCostCenterIDList = ($("#cbCheckAllCostCenters").prop("checked") == true ? "-1" : GetAllSelectedIDsAsStringWithNameAttr("nameCbCostCenter"));
    var pJobIDList =( $("#cbCheckAllJobs").prop("checked") == true ? "-1" : GetAllSelectedIDsAsStringWithNameAttrRPT("nameCbJob"));
    ...
    //    swal("Sorry", "Please, select at least one cost center.");
        ...
        if ($('#slAccountsGroup').val() == "0") {
            if ($("[id$='hf_ChangeLanguage']").val() == "en") {
                ...
                swal("إعتذار", "برجاء إختيار حساب رئيسي", "warning")
            }
            ...
            if ($("#cbIsSummarized").prop("checked")) {
                ...
                if ($("[id$='hf_ChangeLanguage']").val() == "en") {
                    var pParametersWithValues =
                    {
                        ...
                        , pTitle: "Client Account Statement Summary"
                        , pReportName: "Rep_A_ClientAccountStatement_Summary"
                    };
                }
                else {
                    var pParametersWithValues =
                   {
                       arr_Keys: arr_Keys
                       , arr_Values: arr_Values
                       , pTitle: "كشف حساب عميل - الإجمالي"
                       , pReportName: "Rep_A_ClientAccountStatement_Summary_ar"
                   };
                }
            ...
            if ($("#cbIsDetailed").prop("checked")) {
                ...
                if ($("[id$='hf_ChangeLanguage']").val() == "en") {
                    var pParametersWithValues =
                    {
                        arr_Keys: arr_Keys
                        , arr_Values: arr_Values
                        , pTitle: "Client Account Statement"
                        , pReportName: "Rep_A_ClientAccountStatement_Detailed"
                    };
                } else {
                    var pParametersWithValues =
                    {
                        arr_Keys: arr_Keys
                        , arr_Values: arr_Values
                        , pTitle: "كشف حساب عميل"
                        , pReportName: "Rep_A_ClientAccountStatement_Detailed_ar"
                    };
                }
                var win = window.open("", "_blank");
                var url = '/ReportMainClass/PrintWithIDs?pTitle="' + pParametersWithValues.pTitle + '"' + '&arr_Keys=' + pParametersWithValues.arr_Keys + '' + '&arr_Values=' + pParametersWithValues.arr_Values + '  ' + '&pReportName=' + pParametersWithValues.pReportName + '';
            ...
            if ($("#cbIsInvoiceDetailed").prop("checked")) {
                var arr_Keys = new Array();
                var arr_Values = new Array();
                arr_Keys.push("SubAccount_IDs");
                arr_Keys.push("AccountIDs");
                ...
                if ($("[id$='hf_ChangeLanguage']").val() == "en") {
                    var pParametersWithValues =
                    {
                        ...
                        , arr_Values: arr_Values
                        , pTitle: "Client Account Statement"
                        , pReportName: "Rep_A_ClientAccountStatement_WithInvoiceDetails"
                    };
                }
                else {
                    var pParametersWithValues =
                    {
                        ...
                        , arr_Values: arr_Values
                        , pTitle: "كشف حساب عميل"
                        , pReportName: "Rep_A_ClientAccountStatement_WithInvoiceDetails_ar"
                    };
                }
                var win = window.open("", "_blank");
                var url = '/ReportMainClass/PrintWithIDs?pTitle="' + pParametersWithValues.pTitle + '"' + '&arr_Keys=' + pParametersWithValues.arr_Keys + '' + '&arr_Values=' + pParametersWithValues.arr_Values + '  ' + '&pReportName=' + pParametersWithValues.pReportName + '';
                ...
                if ($('#slCurrency').val() == "0") {
                    ...
                    if ($("[id$='hf_ChangeLanguage']").val() == "en") {
                        var pParametersWithValues =
                        {
                            arr_Keys: arr_Keys
                            , arr_Values: arr_Values
                            , pTitle: "Client Account Statement By Currency"
                            , pReportName: "Rep_A_ClientAccountStatement_ByCurrency"
                        };
                    }
                    else {
                        var pParametersWithValues =
                        {
                            arr_Keys: arr_Keys
                            , arr_Values: arr_Values
                            , pTitle: "كشف حساب عميل بالعملة"
                            , pReportName: "Rep_A_ClientAccountStatement_ByCurrency_ar"
                        };
                    }
                    var win = window.open("", "_blank");
                    var url = '/ReportMainClass/PrintWithIDs?pTitle="' + pParametersWithValues.pTitle + '"' + '&arr_Keys=' + pParametersWithValues.arr_Keys + '' + '&arr_Values=' + pParametersWithValues.arr_Values + '  ' + '&pReportName=' + pParametersWithValues.pReportName + '';
