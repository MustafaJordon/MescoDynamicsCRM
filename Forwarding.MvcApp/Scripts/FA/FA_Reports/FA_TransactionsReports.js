...
function Print(pOutputTo) {
    if ($('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByBranch_AR' || $('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByDepreciated_AR' || $('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByGroup_AR')
    {
...
function ShowHideSections() {
    ...
    if ($('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByDepreciated_AR' || $('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByBranch_AR' || $('input[name=nameReportType]:checked').attr('id') == 'FA_FinancialTransByGroup_AR') 
        {
