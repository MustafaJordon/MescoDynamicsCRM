...
$(document).ready(function () {
    ...
    strLoadWithPagingFunctionName = "/api/A_Payments/LoadWithPaging";
    LoadWithPagingWithWhereClause("div-Pager1", "select-page-size1", "spn-first-page-row1", "spn-last-page-row1", "spn-total-count1", "div-Text-Total1", strLoadWithPagingFunctionName, WhereClause, $("#div-Pager li.active a").text(), $('#select-page-size').val().trim()
        , function (pTableRows) {
            ...
            A_Payments_BindTableRows(pTableRows);
            if ($("[id$='hf_ChangeLanguage']").val() == "ar") $(".swapChildrenClass:not(.reversed)").reverseChildren();
...
function A_Payments_BindTableRows(pPayments) {
    debugger;
    
    GetListWithCurrency(null, "/api/A_Payments/LoadAllCurrencyByName", "not null", "slHideCurrency");
    //GetListWithCurrency(null, "/api/A_Payments/LoadAllCurrencyByName", "null", "slBankChargesCurrency");
    //GetListWithCurrency(null, "/api/A_Payments/LoadAllCurrencyByName", "null", "slRefundCurrency");
    //GetListWithBanks(null, "/api/A_Payments/LoadAllBanksByName", "null", "slHideBanks");
    CallGETFunctionWithParameters("/api/A_Payments/LoadAllBanksByName", { pBankID: "1" }
       , function (pData) {
           FillListFromObject(null, 21/*pCodeOrName*/, "<--Select-->", "slHideBanks", pData[0], null);
       }
       , null);

    //GetListWithSafes(null, "/api/A_Payments/LoadAllSafesByName", "null", "slHideSafes");
    CallGETFunctionWithParameters("/api/A_Payments/LoadAllSafesByName", { pSafeID: "1" }
       , function (pData) {
...
function Users_GetList(pYearID, pSelectTxt) {
    debugger;
    GetListWithUsers(pYearID, "/api/A_Payments/LoadAllUsersByName", pSelectTxt, "slUserID");
}
function A_Payment_GetWhereClause() {
    debugger;
     var pWhereClause = "where 1=1";
...
function A_PaymentsSearch_LoadingWithPaging(pPageNo, pPageSize) {
    debugger;
    $("#txtsearchPaymentDate").val(getTodaysDateInddMMyyyyFormat());
    ...
    var pControllerParameters = { pIsLoadArrayOfObjects: true, pLanguage: $("[id$='hf_ChangeLanguage']").val(), pPageNumber: pPageNumber, pPageSize: pPageSize, pWhereClause: pWhereClause, pOrderBy: pOrderBy }
    LoadWithPagingWithWhereClauseAndOrderByWithObjectArrayReturned("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", strLoadWithPagingFunctionName, pWhereClause, pOrderBy, pPageNumber, pPageSize, pControllerParameters, function (pData) { A_Payments_BindTableRows(JSON.parse(pData[0])); });


    FadePageCover(true);
    $(".btn-Options").addClass("hide");
   // LoadWithPagingWithWhereClause("div-Pager1", "select-page-size1", "spn-first-page-row1", "spn-last-page-row1", "spn-total-count1", "div-Text-Total1", "/api/A_Payments/LoadWithPaging", pWhereClause, pPageNo, pPageSize, function (pTableRows) { A_Payments_BindTableRows(pTableRows); });
}
//function A_Payment_GetWhereClause() {
...
function BillNoSearch()
{
    ...
    if ($("#txtBillNo").val() != "") {
        ...
        setTimeout(function () {
            ...
            //LoadWithPagingWithWhereClause("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", "/api/A_Payments/LoadInvoices", pWhereClause2, $("#div-Pager li.active a").text(), $('#select-page-size').val().trim(), function (pTableRows) {
        ...
        debugger;
        LoadWithPagingWithWhereClause("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", "/api/A_Payments/LoadInvoices", pWhereClause, $("#div-Pager li.active a").text(), $('#select-page-size').val().trim(), function (pTableRows) { PaymentsSearchInvoices_BindTableRows(pTableRows); });
    }
}
...
function InvoiceSerialSearch() {
    ...
    if ($("#txtInvoiceSerialSearch").val() != "") {
        ...
        LoadWithPagingWithWhereClause("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", "/api/A_Payments/LoadInvoices", pWhereClause, $("#div-Pager li.active a").text(), $('#select-page-size').val().trim(), function (pTableRows) {
            CurrencyID = pTableRows.length > 0 ? (pTableRows)[0].CurrencyID : 0;
            Currency_GetList(pTableRows.length > 0 ? (pTableRows)[0].CurrencyID : null, "not null");
            if (CurrencyID != 0 && $("#txtPaymentDate").val() != "") {
            PaymentsSearchInvoices_BindTableRows(pTableRows);
...
function Payments_LoadingWithPaging() {
    ...
    //LoadWithPagingWithWhereClause("div-Pager1", "select-page-size1", "spn-first-page-row1", "spn-last-page-row1", "spn-total-count1", "div-Text-Total1", "/api/A_Payments/LoadWithPaging", pWhereClause, "1", $('#select-page-size1').val().trim(), function (pTableRows) { A_Payments_BindTableRows(pTableRows); });
...
function A_Payments_DeleteList() {
    ...
    if (GetAllSelectedIDsAsString('tblPayments', 'Delete') != "")
        ...
        function () {
            ...
            DeleteListFunction("/api/A_Payments/Delete", { "pPaymentIDs": PaymentIDs }, function () { Payments_LoadingWithPaging(); });
        });
 }
...
//    jQuery("#PaymentsModal").modal("show");
//    CallGETFunctionWithParameters("/api/A_Payments/GetPaymentsDetails"
//        , {
//            pPageNumber: 1
//            , pPageSize: 9999
...
//        };
//        CallGETFunctionWithParameters("/api/A_Payments/PaymentsHeader_Save", pParametersWithValues
//            , function (pData) {
...
//            FadePageCover(true);
//            CallGETFunctionWithParameters("/api/A_Payments/GetCode"
//                , {
//                    pSafeID: $("#slSafe").val()
//                    , pBankID: 0
...
//        function () {
//            FadePageCover(true);
//            CallGETFunctionWithParameters("/api/A_Payments/Delete"
...
//        };
//        CallGETFunctionWithParameters("/api/A_Payments/PaymentsDetails_Save", pParametersWithValues
//            , function (pData) {
//                var pMessageReturned = pData[0];
//                if (pMessageReturned == "") {
...
//        swal("Sorry", "A A_Payments can not remain without details.");
...
//        function () {
//            FadePageCover(true);
//            CallGETFunctionWithParameters("/api/A_Payments/Details_Delete"
...
//        , pOrderBy: "ID DESC"
//    }                               
//    CallGETFunctionWithParameters("/api/A_Payments/Copy"
//        , pParametersWithValues
//        , function (pData) {
//            if (pData[0] == "") {
//                A_Payments_BindTableRows(JSON.parse(pData[1]));
//                swal("Success", "Saved successfully.");
//                FadePageCover(false);
//            }
//            else {
...
function Search_Init() {
    ...
    //setTimeout(function () {
        ...
        GetListComboWithNameAndWhereClauses(null, "/api/TaxeTypes/LoadAll", "not null", "slCashTax1", "ID", "Name", "IsDebitAccount = 1");
        GetListComboWithNameAndWhereClauses(null, "/api/TaxeTypes/LoadAll", "not null", "slChequeTax1", "ID", "Name", "IsDebitAccount = 1");
        //GetListComboWithNameAndWhereClauses(null, "/api/A_Payments/GetcheqyeType", "null", "slChequeType1", "ID", "Name", "");
...
function PaymentsSearchInvoices_BindTableRows(pInvoices) {
    ...
    $.each(pInvoices, function (i, item) {
        ...
        if (CurrencyID != "" && (item.InvoiceSerial != "" && item.InvoiceSerial != "0")) {
...
function chSearchClient() {
    ...
    if (counter == 0) {
        ...
        // LoadWithPagingWithWhereClause("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", "/api/A_Payments/LoadInvoices", pWhereClause, "1", $('#select-page-size').val().trim(), function (pTableRows) { PaymentsSearchInvoices_BindTableRows(pTableRows); });
    ...
    //$('#slSearchCurrency').change(function () {
        ...
        if ($("#slSearchClient option:selected").text() != "Select Client" && $("#slSearchCurrency option:selected").val() != "") {
            ...
            if ($("#txtBillNo").val().trim() !="") {
                pWhereClause += "and BillNumber = '" + $("#txtBillNo").val().trim() + "' ";
            }
...
function A_Search_LoadingWithPaging(pPageNo, pPageSize) {
    ...
    FadePageCover(true);
    $(".btn-Options").addClass("hide");
    LoadWithPagingWithWhereClause("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", "/api/A_Payments/LoadInvoices", pWhereClause, pPageNo, pPageSize, function (pTabelRows) { PaymentsSearchInvoices_BindTableRows(pTabelRows); });
}
...
function Currency_GetList(pCurrencyID, pSelectTxt) {
    debugger;
    GetListWithCurrency(pCurrencyID, "/api/A_Payments/LoadAllCurrencyByName", pSelectTxt, "slSearchCurrency");
}

function Clients_GetList(pBillNo, pSelectTxt) {
    debugger;
    GetListWithClients(pBillNo, "/api/A_Payments/LoadAllClientsByName", pSelectTxt, "slSearchClient");
}
function Clients_GetListInvoiceSearch(pBillNo, pSelectTxt) {
    debugger;
    GetListWithClients(pBillNo, "/api/A_Payments/LoadAllClientsByNameWithInvoice", pSelectTxt, "slSearchClient");
}
...
function Cash_BindTableRows() {
    ...
    ("<tr counter='" + CashRows + "' value='" + 0 + "'>"
                ...
                + "<td class='NewExchangeRate" + CashRows + "' ><input type='number' id='txtNewCashExchangeRate" + CashRows + "'  data-required='false' class='input-sm form-control' tabindex='5'/></td>"
...
function Cheque_BindTableRows() {
    debugger;
    //GetListComboWithNameAndWhereClauses(null, "/api/A_Payments/GetcheqyeType", "null", "slChequeType" + ChequeRows, "ID", "Name", "");
    ...
    ("<tr counter='" + ChequeRows + "' value='" + 0 + "'>"
                ...
                + "<td class='NewExchangeRate" + ChequeRows + "' ><input type='number' id='txtNewChequeExchangeRate" + ChequeRows + "' data-required='false' class='input-sm form-control' tabindex='5'/></td>"
...
function Safes_GetList(pCurrencyID, pSelectTxt) {
    debugger;
   // GetListWithSafes(pCurrencyID, "/api/A_Payments/LoadAllSafesByName", pSelectTxt, "slHideSafes");
    //GetListWithSafesByCurrencyID(pCurrencyID, "/api/A_Payments/LoadAllSafesByName", pSelectTxt, "slCashSafe1");
    //CallGETFunctionWithParameters("/api/A_Payments/LoadAllSafesByName", { pSafeID: "1" }
    CallGETFunctionWithParameters("/api/A_Payments/LoadAllSafesByName", { pSafeID: pCurrencyID }
...
function Banks_GetList(pBankID, pSelectTxt) {
    ...
    CallGETFunctionWithParameters("/api/A_Payments/LoadAllBanksByName", { pBankID: pBankID}
       , function (pData) {
           FillListFromObject(null, 21/*pCodeOrName*/, "<--Select-->", "slChequeBank1", pData[0], null);
           FillListFromObject(null, 21/*pCodeOrName*/, "<--Select-->", "slDepositeBank1", pData[0], null);
           FillListFromObject(null, 21/*pCodeOrName*/, "<--Select-->", "slTransferBank1", pData[0], null);

       }
       , null);
   // GetListComboWithNameAndWhereClauses(pBankID, "/api/A_Payments/LoadAllBanksByName", "null", "slBank", "ID", "Name", "");

   // GetListWithBanks(pBankID, "/api/A_Payments/LoadAllBanksByName", pSelectTxt, "slHideBanks");
   // GetListWithBankByCurrencyID(pBankID, "/api/A_Payments/LoadAllBanksByName", pSelectTxt, "slChequeBank1");

}
//function Safes_GetList(pCurrencyID, pSelectTxt) {
//    debugger;
//    GetListWithSafes(pCurrencyID, "/api/A_Payments/LoadAllSafesByName", pSelectTxt, "slCashSafe");
//}

//function Banks_GetList(pBankID, pSelectTxt) {
//    debugger;
//    GetListWithBanks(pBankID, "/api/A_Payments/LoadAllBanksByName", pSelectTxt, "slChequeBank");
//}
...
var InvoicesRremain = "";
function Payments_Save() {
    $.getJSON('/api/A_Payments/CheckFiscalYear', { pVoucherDate: ConvertDateFormat($("#txtPaymentDate").val()), pCurrencyID: $("#slSearchCurrency option:selected").val()}, function (pResult) {
        debugger;
        if (pResult[0] == false) {
            _Suceess = false;
                ...
                if ($("#txtPaymentDate").val() != "") {
                    ...
                    if (ChequeBoolEdit == false || CashBoolEdit == false || DepositeBoolEdit == false || TransferBoolEdit == false) {
                        ...
                        if (CashBool || ChequeBool || DepositeBool || TransferBool) {
                            ...
                            $.getJSON('/api/A_Payments/GetAccountIDAndSubAccountID', { pClientID: pWhereClause }, function (Result) {
                                debugger;
                                ...
                                if (AccountID != "" && SubAccountID != "" && $("#hLoggedUserID").val() != -1) {
                                    ...
                                    if (CheckPaymentMoneyCheck() == true) {
                                        swal({
                                            title: "Are you sure?",
                                            text: "The Amount Paid Is More Than The Value Of The Vouchers!",
                                            type: "warning",
                                            showCancelButton: true,
                                            confirmButtonColor: "#DD6B55",
                                            ...
                                            function () {
                                                ...
                                                if (CheckPaymentMoney() == "1") {
                                                    ...
                                                    debugger;
                                                    //FadePageCover(true);
                                                    CallPOSTFunctionWithParameters("/api/A_Payments/Insert", pParametersWithValuesVoucherPayments
                                                        , function (pData) {
                                                            debugger;
                                                            //InvoicesIDs = "";
                                                            if (pData[0] == true) {
                ...
                if (pData[0] == true) {
                    ...
                    if (ChequeBool == false) {
                        ...
                        if (CashCurrencyID != PaymentCurrencyID) {
                            ...
                            CallGETFunctionWithParameters("/api/A_Payments/InsertA_JVAndA_JVDetails", { pInvoicesIDs: InvoicesIDs, pCheck: true }
                              , function (pData) {
                                  debugger;
                                  InvoicesIDs = "";
                                  if (pData == true) {
                            ...
                            CallGETFunctionWithParameters("/api/A_Payments/InsertA_JVAndA_JVDetails", { pInvoicesIDs: InvoicesIDs, pCheck: false }
                              , function (pData) {
                                  debugger;
                                  InvoicesIDs = "";
                                  if (pData == true) {
...
var InvoicesIDsCheck = "";

function CheckPaymentMoneyCheck() {
    debugger;
    var VouchersTotalMoney = 0;
    $("#tblInvoices  tbody tr").each(function () {
        if ($(this).find("#txtChoose").is(":checked") == true)
    ...
    if (VouchersTotalMoney != 0) {
        debugger;
        InvoicesIDsCheck = GetTableCellsAsStringWhenCellISChecked("tblInvoices", "InvoiceID", "txtChoose");
        ...
        if (EgpVouchersTotalMoney != 0) {
            ...
            if (parseFloat((EgpPaymentTotalMoney).toFixed(2)) > parseFloat(EgpVouchersTotalMoney.toFixed(2))) {
                ...
                returned_valueCheck = true;


            }
            else {
                returned_valueCheck = false;
    ...
    return returned_valueCheck;
}

function ClientGroups_GetList() {
    debugger;
    CallGETFunctionWithParameters("/api/A_Payments/LoadAllClientsGroupsByName", {}
        , function (pData) {
...
function Deposite_BindTableRows() {
    ...
    ("<tr counter='" + DepositeRows + "' value='" + 0 + "'>"
                ...
                + "<td class='NewDepositeExchangeRate" + DepositeRows + "' ><input type='number' id='txtNewDepositeExchangeRate" + DepositeRows + "' data-required='false' class='input-sm form-control' tabindex='5'/></td>"
...
function Transfer_BindTableRows() {
    ...
    ("<tr counter='" + TransferRows + "' value='" + 0 + "'>"
                ...
                + "<td class='NewTransferExchangeRate" + TransferRows + "' ><input type='number' id='txtNewTransferExchangeRate" + TransferRows + "' data-required='false' class='input-sm form-control' tabindex='5'/></td>"
