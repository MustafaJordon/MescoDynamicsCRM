function Post_Unpost_Voucher_BindTableRows(pVoucher) {
    debugger;
...
function Post_Unpost_Voucher_LoadingWithPaging() {
    debugger;
    ...
    LoadWithPagingWithWhereClauseAndOrderByWithObjectArrayReturned("div-Pager", "select-page-size", "spn-first-page-row", "spn-last-page-row", "spn-total-count", "div-Text-Total", strLoadWithPagingFunctionName, pWhereClause, pOrderBy, pPageNumber, pPageSize, pControllerParameters, function (pData) { Post_Unpost_Voucher_BindTableRows(JSON.parse(pData[0])); });
    //HighlightText("#tblVoucher>tbody>tr", $("#txt-Search").val().trim());
}
function Post_Unpost_Voucher_GetWhereClause() {
...
function Post_Unpost_Voucher_cbIsJVDateChanged() {
    debugger;
...
function Post_Unpost_Voucher_PostOrUnpostList(pValue) { //pValue 1:Post, 2:Unpost
    debugger;
