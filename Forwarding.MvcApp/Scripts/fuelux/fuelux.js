...
+function ($) {
    ...
    var Datagrid = function (element, options) {
        ...
        if (this.$pagesize.hasClass('select')) {
            ...
            this.options.dataOptions.pageSize = parseInt(this.$pagesize.val().trim(), 10);
        }
    ...
    Datagrid.prototype = {
        ...
        pagesizeChanged: function (e, pageSize) {
            if (pageSize) {
                ...
                this.options.dataOptions.pageSize = parseInt($(e.target).val().trim(), 10);
            }
        ...
        pageChanged: function (e) {
            var pageRequested = parseInt($(e.target).val().trim(), 10);
...
+function ($) {
    ...
    Wizard.prototype = {
        ...
        setState: function () {
            ...
            //sherif: this is for the Prev button : i did no changes
            ...
            $steps.find('span.badge').removeClass('badge-success')//.removeClass('badge-info');
            ...
            //sherif
            //$currentStep.find('span.badge').addClass('badge-success');
