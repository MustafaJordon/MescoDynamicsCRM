...
function BranchLedger_hide() {
    debugger;
    $("#secBranch").addClass("hide");
}
...
function SubAccountLedger_Print(pOutputTo)
{
    ...
    var pSubAccountIDList = (glbCallingControl == "AccountStatement"
                            ? pSubAccountIDList = $("#slSubAccount").val()
    ...
    if (pSubAccountIDList == "" && ($("#cbIsByCostCenter").prop("checked")) == false && ($("#cbIsCostCenterSummary").prop("checked")) == false && ($("#cbIsCostCenterProfit").prop("checked")) == false)
        ...
        var pIsGroupedByBranch;
        if ($("#cbIsGroupByBranch").prop("checked"))
            pIsGroupedByBranch = true;
        else
            pIsGroupedByBranch = false;
        ...
        var pParametersWithValues = {
           ...
           , pIsGroupedByBranch: pIsGroupedByBranch
            ...
            , pBankTemplateID: ($("#slBankTemplate").val() == '' ? 0 : $("#slBankTemplate").val())
            , pIsAccrual:  $("#cbIsAccrual").prop("checked") ? true : false
        };
        CallPOSTFunctionWithParameters("/api/SubAccountLedger/GetPrintedData", pParametersWithValues
            , function (pData) {
                if ($("#hDefaultUnEditableCompanyName").val() == "ONE") {
                    if ($("#cbIsDetails").prop("checked"))
                        ...
                        SubAccountLedger_Print_GroupByBranch_OneEgypt(pData, pOutputTo);
                }
                else { //otherCompanies
                    if ($("#cbIsDetails").prop("checked"))
                        ...
                        SubAccountLedger_Print_ByBranch(pData, pOutputTo);
                    ...
                    {
                        if (pDefaults.UnEditableCompanyName == 'SEF' && $("#cbIsClientStatmentEn").prop("checked"))
                            SubAccountLedger_Print_ClientStatmentEn_SEF(pData, pOutputTo);
                            else
...
function SubAccountLedger_Print_GroupByBranch_OneEgypt(pData, pOutputTo) {
    debugger;
    //if ($("#slSubAccount option:selected").text().split(': ')[1].substring(0, 1) == "4")
    var pSubAccountIDList = (glbCallingControl == "AccountStatement"
                            ? pSubAccountIDList = $("#slSubAccount").val()
    ...
    var pDefaultsHeader = JSON.parse(pData[0]);
    var pTblRows = JSON.parse(pData[1]);
    var pTblRowsGroupByBranch = JSON.parse(pData[2]);
    var pTblRowsGroupByBranchSum = JSON.parse(pData[3]);
    var pFormattedTodaysDate = getTodaysDateInddMMyyyyFormat();
    var pFormattedPrintTime = getTime();
    var ArrSubAccountIDList = pSubAccountIDList.split(',');
    ...
    for (var k = 0; k < ArrBranchIDList.length; k++) {
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            var pIsOpenBalanceRowAdded = false;
            pTablesHTML += '             <table id="tblSubAccountLedger' + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + '" class="table table-striped text-sm  table-bordered" style="">';  //style="border:solid #000 !Important;" 
            pTablesHTML += '                 <thead class="" style="">';
            pTablesHTML += '                     <th class="">' + 'JournalNo.' + '</th>';
            pTablesHTML += '                     <th class="">' + 'Journal Date' + '</th>';
            pTablesHTML += '                     <th class="">' + 'Account' + '</th>';
            ...
            pTablesHTML += '                 </thead>';
            pTablesHTML += '                 <tbody>';
            if (pOutputTo == "Excel") { //to add the name of SubAccount and Branch for the excel files
                pTablesHTML += '                 <tr class="" style="font-size:95%;">';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + 'SubAccount : ' + $("#divCbSubAccount input[name=nameCbSubAccount][value=" + ArrSubAccountIDList[j] + "]").siblings().text().trim() + " (" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim() + ")" + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
            ...
            var pPreviousRowFBalanceD = 0; //final balance $
            var pPreviousRowFBalance = 0; //final balance Local Cur
            $.each(pTblRowsGroupByBranch, function (i, item) {
                if (item.SubAccountID == ArrSubAccountIDList[j]
    ...
    for (var k = 0; k < ArrBranchIDList.length; k++) {
        ...
        var pTotalForeignCurDebit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "Deb");
        var pTotalForeignCurCredit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "Cre");
        var pTotalLocalDebit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "LocalDebit");
        var pTotalLocalCredit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "LocalCredit");
        var pSummaryForeignCurBalance = $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalanceD").text() == "" ? 0 : $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalanceD").text();
        var pSummaryLocalCurBalance = $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalance").text() == "" ? 0 : $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalance").text();
        var pRowTotalsHTML = "";
        pRowTotalsHTML += '                            <tr class="" style="font-size:95%;">';
        if (pOutputTo != "Excel")
            pRowTotalsHTML += '                                <td class="" colspan="3" style="text-align:center;"><b><u>' + 'Totals:</u></b> &emsp;' + '</td>';
        ...
        pRowTotalsHTML += '                                <td style="text-align:center;" class="">' + pTotalLocalCredit.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + '</td>';
        pRowTotalsHTML += '                                <td style="text-align:center;" class="">' + '</td>';
        if ($("#tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr").length == 1) //no transactions within this period, so final balance is the open balance
            pRowTotalsHTML += '                                <td style="text-align:center;" class="">' + $("#tblSubAccountLedger" + ArrSubAccountIDList[j] + " tbody tr:first td:last").text() + '</td>';
        else
            pRowTotalsHTML += '                                <td style="text-align:center;" class="">' + pSummaryForeignCurBalance + ' $' + (pOutputTo == "Excel" ? '       ' : '&emsp;&emsp;&emsp; ') + pSummaryLocalCurBalance + ' ' + $("#hDefaultCurrencyCode").val() + '</td>';
        pRowTotalsHTML += '                            </tr>';
        $("#tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody").append(pRowTotalsHTML);

    } //of looping through Branchs
    if (pOutputTo == "Excel") {
        var ReportExcelSumCurrencyByCC = "";
        for (var k = 0; k < ArrBranchIDList.length; k++)
            for (var j = 0; j < ArrSubAccountIDList.length; j++) {
                ...
                ReportExcelSumCurrencyByCC += '                  <td class="">' + '' + '</td>';
                ReportExcelSumCurrencyByCC += '             </tr>';
                $.each(pTblRowsGroupByBranchSum, function (z, rowSum) {
                    if (//ArrSubAccountIDList[j] == rowSum.SubAccount_ID &&
                        ArrBranchIDList[k] == rowSum.Branch_ID) {
                        ReportExcelSumCurrencyByCC += '             <tr class="">';
                        ReportExcelSumCurrencyByCC += '                  <td class="">' + '' + '</td>';
                        ReportExcelSumCurrencyByCC += '                  <td class="">' + '' + '</td>';
                        ReportExcelSumCurrencyByCC += '                  <td class="">' + '' + '</td>';
                ...
                /*****************************EOF Appending rows for Excel SumCurrencyByCC****************************************/
                $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody").append(ReportExcelSumCurrencyByCC);
                ReportExcelSumCurrencyByCC = '';
                ExportHtmlTableToCsv_RemovingCommasForNumbers("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''));
            }//for (var j = 0; j < ArrSubAccountIDList.length; j++)
    }//if (pOutputTo == "Excel")
        ...
        for (var k = 0; k < ArrBranchIDList.length; k++) {
            ...
            //ReportHTML += '             <div class="col-xs-3"><b>' + 'Printed By :  ' + '</b>' + $("#hLoggedUserNameNotLogin").val() + '</div>';
            ReportHTML += '     <hr style="width:100%;height:0px;border:.5px solid #000;">';
            ReportHTML += '             <div class="col-xs-12"><h4><b>' + 'SubAccount : ' + '</b>' + " (" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim() + ")" + '</h4></div>';
            //ReportHTML += pTablesHTML; //Add table html in the next lines
            ReportHTML += '             <table id="tblSubAccountLedger' + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + '" class="table table-striped text-sm  table-bordered" style="">';  //style="border:solid #000 !Important;" 
            ReportHTML += '             ' + $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '')).html();
            ReportHTML += '             </table>';
            ...
            ReportHTML += '             <div class="col-xs-12"></div>';
            ReportHTML += '                 <div class="col-xs-4">';
            ReportHTML += '                     <table id="tblSumCurrencyByCC' + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + '" class="m-t table table-striped text-sm  table-bordered" style="">';  //style="border:solid #000 !Important;" 
            ReportHTML += '                         </tbody>';
            $.each(pTblRowsGroupByBranchSum, function (i, item) {
                if (//ArrSubAccountIDList[j] == item.SubAccount_ID &&
                     ArrBranchIDList[k] == item.Branch_ID) {
                    ReportHTML += '             <tr class="">';
                    ReportHTML += '                  <td class="">' + item.FinalBalance + '</td>';
                    ReportHTML += '                  <td class="">' + item.Currency_Code + '</td>';
                    ReportHTML += '             </tr>';
            ...
            //ReportHTML += '             <div class="col-xs-12 m-t-n text-right"><b>' + 'Total records :  ' + '</b>' + pTblRowsGroupByBranch.length + '</div>';
        } //for (var k = 0; k < ArrBranchIDList.length; k++)
...
function SubAccountLedger_Print_Detailed(pData, pOutputTo) {
    ...
    for (var j = 0; j < ArrSubAccountIDList.length; j++) {
        ...
        if (pDefaults.UnEditableCompanyName == "NIS") {
            pTablesHTML += '                                     <th>PODName</th>';
            pTablesHTML += '                                     <th>POLName</th>';
            pTablesHTML += '                                     <th>ChargeableWeight</th>';
        ...
        $.each(pTblRows, function (i, item) {
            if (item.SubAccount_ID == ArrSubAccountIDList[j]) {
                if (!pIsOpenBalanceRowAdded) { //Table 1st row (open balance)
                    pTablesHTML += '             <tr class="" style="font-size:95%;">';
                    if (pOutputTo != "Excel") {
                        pTablesHTML += '                 <td class="" colspan=' + (pDefaults.UnEditableCompanyName == "NIS" ? ($("#cbShowSubAccount").prop("checked") ? '15' : '15') :  ($("#cbShowSubAccount").prop("checked") ? '12' : '12') )+ ' style="text-align:center;"><b><u>' + 'Opening Balance:</u></b> &emsp;' + '</td>';
                        ...
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td stylSe="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                ...
                if (item.ID/*JV_ID*/ != 0) { //add normal row
                    ...
                    if (pDefaults.UnEditableCompanyName == "NIS") {
                        var Desc = item.Description2;
                        var res = Desc.trim().charAt(0);
                        if (res == '-')
                            Desc = Desc.trim().substring(1, Desc.length);

                        pTablesHTML += '                     <td style="text-align:center;" class="">' + Desc + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + item.PODName + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + item.POLName + '</td>';
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + item.ChargeableWeightSum + '</td>';
                    } else
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + item.Description2 + '</td>';
    ...
    for (var j = 0; j < ArrSubAccountIDList.length; j++) {
        ...
        if (pOutputTo != "Excel") {
            ...
            if (pDefaults.UnEditableCompanyName == "NIS") {
                if ($("#tblSubAccountLedger" + ArrSubAccountIDList[j] + " tbody tr").length == 1) //no transactions within this period, so final balance is the open balance
                    pRowTotalsHTML += '                                <td colspan="5"  style="text-align:center;" class="">' + 'Balance: ' + $("#tblSubAccountLedger" + ArrSubAccountIDList[j] + " tbody tr:first td:last").text() + '</td>';
                else
                    pRowTotalsHTML += '                                <td colspan="5"  style="text-align:center;" class="">' + 'Balance: ' + pSummaryLocalCurBalance + (pOutputTo == "Excel" ? '       ' : '&emsp;&emsp;&emsp; ') //+ 'Posted: ' + pSummaryLocalCurBalance_Posted
                        + '</td>';
            }
            else {
                if ($("#tblSubAccountLedger" + ArrSubAccountIDList[j] + " tbody tr").length == 1) //no transactions within this period, so final balance is the open balance
...
for (var j = 0; j < ArrSubAccountIDList.length; j++) {
    ...
    if (pOutputTo == "Excel") {
        ...
        if ($("[id$='hf_ChangeLanguage']").val() == "en") {
            ...
            for (var j = 0; j < ArrSubAccountIDList.length; j++) {
                ...
                if (!Suppress || CurrentRows.length > 0) {
                    ...
                    ReportHTML += '                     <table id="tblHeader' + ArrSubAccountIDList[j] + '" class="m-t table table-striped text-sm   style="">';  //style="border:solid #000 !Important;" 
                    ReportHTML += '                         <tbody>';
                    if (j > 0) {
                        ReportHTML += '             </tr>';
                        ReportHTML += '             <tr class="">';
                    ...
                    ReportHTML += '             <tr class="">';
                    ReportHTML += '                  <td class="col-xs-12"style="border: 1px solid black;" ><h4><b>' + 'SubAccount : ' + '</b>' + $("#divCbSubAccount input[name=nameCbSubAccount][value=" + ArrSubAccountIDList[j] + "]").siblings().text().trim() + '</h4> </td>';
                    ReportHTML += '             </tr>';
                    ReportHTML += '                         </tbody>';
                    ReportHTML += '                     </table>';
        ...
        $("#Reportbody").table2excel({
            ...
            name: "Sheet 1",
            filename: "Sub Account Ledger " + pFormattedTodaysDate  //do not include extension
        });
    //for (var j = 0; j < ArrSubAccountIDList.length; j++)
    //{
    //    var CurrentRows = pTblRows.filter(x=> x.SubAccount_ID == ArrSubAccountIDList[j]);
...
ReportHTML += '</html>';
    ...
    if (pOutputTo != "Email" && pOutputTo != "PrintInReportBody") {
        ...
        SendPDF_ReportByEmail($('#txtToEmail').val(), ReportHTML, "Branch", true);
    }
    }
    FadePageCover(false);
}
function SubAccountLedger_Print_ByBranch(pData, pOutputTo) {
    debugger;
    //if ($("#slSubAccount option:selected").text().split(': ')[1].substring(0, 1) == "4")
    var pSubAccountIDList = (glbCallingControl == "AccountStatement"
                            ? pSubAccountIDList = $("#slSubAccount").val()
    ...
    if ($("[id$='hf_ChangeLanguage']").val() == "ar") {
        for (var k = 0; k < ArrBranchIDList.length; k++) {
            var pIsOpenBalanceRowAdded = false;
            pTablesHTML += '             <table id="tblSubAccountLedger' + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + '" class="table table-striped text-sm  table-bordered" style="">';  //style="border:solid #000 !Important;" 
            pTablesHTML += '                 <thead class="" style="">';
            pTablesHTML += '                     <th class="">' + 'رقم القيد' + '</th>';
            pTablesHTML += '                     <th class="">' + 'تاريخ القيد' + '</th>';
            pTablesHTML += '                     <th class="">' + 'رقم الإيصال' + '</th>';
            ...
            if (pOutputTo == "Excel") { //to add the name of SubAccount and Branch for the excel files
                pTablesHTML += '                 <tr class="" style="font-size:95%;">';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + " (" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim() + ")" + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
                pTablesHTML += '                     <td style="text-align:center;" class="">' + '' + '</td>';
            ...
            var pPreviousRowFBalance = 0; //final balance Local Cur
            $.each(pTblRowsGroupByBranch, function (i, item) {
                if (item.BranchName.trim() == $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim()) {
                    if (!pIsOpenBalanceRowAdded) { //Table 1st row (open balance)
                        pTablesHTML += '             <tr class="" style="font-size:95%;">';
                        if (pOutputTo != "Excel") {
        ...
        debugger;
        for (var k = 0; k < ArrBranchIDList.length; k++) {
            //var pTotalForeignCurDebit = GetColumnSum("tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "Deb");
            //var pTotalForeignCurCredit = GetColumnSum("tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "Cre");
            var pTotalLocalDebit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "LocalDebit");
            var pTotalLocalCredit = GetColumnSum("tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, ''), "LocalCredit");
            //var pSummaryForeignCurBalance = $("#tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalanceD").text() == "" ? 0 : $("#tblSubAccountLedger" + ArrSubAccountIDList[j] + "-" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalanceD").text();
            var pSummaryLocalCurBalance = $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalance").text() == "" ? 0 : $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody tr:last td.FBalance").text();
            var pRowTotalsHTML = "";
            pRowTotalsHTML += '                            <tr class="" style="font-size:95%;">';
            if (pOutputTo != "Excel") {
            ...
            pRowTotalsHTML += '                            </tr>';
            $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + " tbody").append(pRowTotalsHTML);
    ...
    if (pOutputTo == "Excel") {
        var ReportExcelSumCurrencyByCC = "";
        for (var k = 0; k < ArrBranchIDList.length; k++) {
            var CureentRows = pTblRowsGroupByBranch.filter(x=> (x.SubAccountID == "" && x.BranchID == ArrBranchIDList[k]));
            if (!Suppress || CureentRows.length > 0) {
                /*****************************Appending rows for Excel SumCurrencyByCC****************************************/
                ReportExcelSumCurrencyByCC = '             <tr class="">';
                ReportExcelSumCurrencyByCC += '                  <td class="">' + '' + '</td>';
        ...
        if ($("[id$='hf_ChangeLanguage']").val() == "en") {
            ...
            ReportHTML += '     <head><title>' + 'Branch' + '</title><link rel="stylesheet" href="/Content/CSS/app.v2.css" type="text/css" /></head>';
            ReportHTML += '         <body style="background-color:white;">';
            for (var k = 0; k < ArrBranchIDList.length; k++) {

                debugger;
                var CureentRows = pTblRowsGroupByBranch.filter(x=> (x.SubAccountID == 0 && x.BranchID == ArrBranchIDList[k]));
                if (!Suppress || CureentRows.length > 0) {

                    //if (i > 0)
                    ReportHTML += '         <div class="break"></div>';
                    //ReportHTML += '             <div class="col-xs-12 text-center"><img src="/Content/Images/CompanyHeader.jpg" alt="logo"/></div>';
                    ReportHTML += '             <div class="col-xs-12 text-center" style="font-size: 20px;"><b><u>Branch</u></b>' + '</div>';
                    ReportHTML += '             <div class="col-xs-3"><b>' + 'From : ' + '</b>' + $("#txtFromDate").val() + '</div>'
                    ReportHTML += '             <div class="col-xs-3"><b>' + 'To : ' + '</b>' + $("#txtToDate").val() + '</div>'
                    ReportHTML += '             <div class="col-xs-6 text-right"><b>' + 'Printed at :  ' + '</b>' + pFormattedTodaysDate + ' ' + pFormattedPrintTime + '</div>';
                    //ReportHTML += '             <div class="col-xs-3"><b>' + 'Printed By :  ' + '</b>' + $("#hLoggedUserNameNotLogin").val() + '</div>';
                    ReportHTML += '     <hr style="width:100%;height:0px;border:.5px solid #000;">';
                    ReportHTML += '             <div class="col-xs-12"><h4><b>' + '</b>' + " (" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim() + ")" + '</h4></div>';
                    //ReportHTML += pTablesHTML; //Add table html in the next lines
                    ReportHTML += '             <table id="tblSubAccountLedger' + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '') + '" class="table table-striped text-sm  table-bordered" style="">';  //style="border:solid #000 !Important;" 
                    ReportHTML += '             ' + $("#tblSubAccountLedger" + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '')).html();
                    ReportHTML += '             </table>';
                    ...
                    ReportHTML += '                 <div class="col-xs-12">';
                    ReportHTML += '                     <table id="tblSumCurrencyByCC'
                        + $("#divCbBranch input[name=nameCbBranch][value=" + ArrBranchIDList[k] + "]").siblings().text().trim().replace(/[\, ()/*.]/g, '')
                      + '" class="m-t table table-striped text-sm   style="">';  //style="border:solid #000 !Important;" 

                    ReportHTML += '                         </tbody>';
                    $.each(pTblRowsGroupByBranchSum, function (i, item) {
                        if (item.SubAccount_ID == 0 && ArrBranchIDList[k] == item.Branch_ID) {
                            ReportHTML += '             <tr class="">';
                            ReportHTML += '                  <td class="col-xs-2"style="border: 1px solid black;" >' + item.FinalBalance + '</td>';
                            ReportHTML += '                  <td class="col-xs-2" style="border: 1px solid black;">' + item.Currency_Code + '</td>';
                            ReportHTML += '                  <td class="col-xs-4 " >' + '</td>';
...
function SubAccountLedger_Print_ClientStatmentEn(pData, pOutputTo) {
    ...
    var pSubAccountIDList = (glbCallingControl == "AccountStatement"
                            ? $("#slSubAccount").val()
                            : GetAllSelectedIDsAsStringWithNameAttr("nameCbSubAccount"));
    var pAccountIDList = GetAllSelectedIDsAsStringWithNameAttr("nameCbAccount");
    var pCostCenterIDList = GetAllSelectedIDsAsStringWithNameAttr("nameCbCostCenter");
    ...
    if ($("#cbIsAccrual").prop("checked") )
         pTblClientStatment = JSON.parse(pData[13]);

    var pBankDetailsTemplate = '';

    if (JSON.parse(pData[12]).length > 0)
    pBankDetailsTemplate= JSON.parse(pData[12])[0].Subject;
    ...
    if ($("#hDefaultUnEditableCompanyName").val() == "FRE" || pDefaults.UnEditableCompanyName == "WAV") {
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            if (CurrentClient.length > 0) {
                ...
                if ($("#hDefaultUnEditableCompanyName").val() == "FRE")
                {
    ...
    else
    {
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            if (CurrentClient.length > 0) {
                ...
                pTablesHeaderHTML += '     <br>';
                if ($("#hDefaultUnEditableCompanyName").val() != "CFR") {
            ...
            if (IsAgent == false && pDefaults.UnEditableCompanyName == 'KDM')
                pTablesHTML += '                     <th class="col-xs-2">' + 'House Number' + '</th>';
            if (IsAgent == false &&  pDefaults.UnEditableCompanyName == 'ELI')
                pTablesHTML += '                     <th class="col-xs-2">' + 'Due Date' + '</th>';
            ...
            $.each(pTblClientStatment, function (i, item) {
                if (item.SubAccount_ID == ArrSubAccountIDList[j] && item.Currency_ID == CurrencyID) {
                    ...
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + (Date.prototype.compareDates("01/01/1900", GetDateWithFormatMDY(item.JVDate)) < 1 ? "" : ConvertDateFormat(GetDateWithFormatMDY(item.JVDate))) + '</td>';
                    if (IsAgent == false && pDefaults.UnEditableCompanyName == 'KDM')
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + item.HouseNumber + '</td>';
                    if (IsAgent == false &&  pDefaults.UnEditableCompanyName == 'ELI')
                        pTablesHTML += '                     <td style="text-align:center;" class="">' + (Date.prototype.compareDates("01/01/1900", GetDateWithFormatMDY(item.DueDate)) < 1 ? "" : ConvertDateFormat(GetDateWithFormatMDY(item.DueDate))) + '</td>';
        ...
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            var pRowTotalsHTML = "";
            pRowTotalsHTML += '                            <tr class="" style="font-size:95%;">';
            if (IsAgent == false && (pDefaults.UnEditableCompanyName == 'KDM' || pDefaults.UnEditableCompanyName == 'ELI') )
            ...
            //pRowTotalsHTML += '                                <td colspan="2" style="text-align:center;" class=""><b> Debit Balance Due To You </b>' + '</td>';
            if (pDefaults.UnEditableCompanyName == "NIS") {
                pRowTotalsHTML += '                                <td colspan="6" style="text-align:center;" class="">' + pSummaryLocalCurBalance + ' ' + $("#slCurrency").find('option:selected').text().trim() + '</td>';
            }
            else {
                pRowTotalsHTML += '                                <td colspan="3" style="text-align:center;" class="">' + pSummaryLocalCurBalance + ' ' + $("#slCurrency").find('option:selected').text().trim() + '</td>';
            }
            ...
            for (var j = 0; j < ArrSubAccountIDList.length; j++) {
                ...
                if (CurrentRows.length > 0) {
                    ...
                    if ($("#hDefaultUnEditableCompanyName").val() != "SAF" && $("#hDefaultUnEditableCompanyName").val() != "NIL"
                        && $("#hDefaultUnEditableCompanyName").val() != "CFR" && $("#hDefaultUnEditableCompanyName").val() != "SWI")
                    {
                        ReportHTML += ' <div class="col-xs-12" > All business is transacted  in accordance with our standard trading condition including the company`s liability </div>';
                        ReportHTML += ' <div class="col-xs-12" >and include jurisdiction place copy is available upon request </div>';
                    }

                        if (pBankDetailsTemplate != '')
                        {
...
function SubAccountLedger_Print_ClientStatmentAr(pData, pOutputTo) {
    ...
    for (var j = 0; j < ArrSubAccountIDList.length; j++) {
        ...
        if (IsAgent == false &&  pDefaults.UnEditableCompanyName == 'KDM')
            pTablesHTML += '                     <th class="col-xs-2">' + 'رقم البوليصة الهاوس ' + '</th>';
        if (IsAgent == false && pDefaults.UnEditableCompanyName == 'ELI')
            pTablesHTML += '                     <th class="col-xs-2">' + 'تاريخ الاستحقاق' + '</th>';
    ...
    for (var j = 0; j < ArrSubAccountIDList.length; j++) {
        ...
        if (IsAgent == false && (pDefaults.UnEditableCompanyName == 'KDM' || pDefaults.UnEditableCompanyName == 'ELI'))
            pRowTotalsHTML += '                                <td colspan="3" style="text-align:center;" class=""><b><u>' + 'الإجمالي</u></b> &emsp;' + '</td>';
        else
        ...
        {
            if ( pDefaults.UnEditableCompanyName == 'KDM' || pDefaults.UnEditableCompanyName == 'ELI')
                pRowTotalsHTML += '                                <td colspan="3" style="text-align:center;" class=""><b> الرصيد </b>' + '</td>';
            else
                pRowTotalsHTML += '                                <td colspan="2" style="text-align:center;" class=""><b> الرصيد </b>' + '</td>';
        }
    ...
    for (var j = 0; j < ArrSubAccountIDList.length; j++) {
        ...
        if (CurrentRows.length > 0) {
            ...
            ReportHTML += '                 </div>';
                    ...
                    if (pBankDetailsTemplate != '') {
                        ReportHTML += '                         <div class="col-xs-8" dir="ltr">';
                        ReportHTML += '                             <b><u>بيانات البنك:</u></b>' + '</br>';
                        ReportHTML += '                         ' +pBankDetailsTemplate.replace(/\n/g, "<br/>");
                        ReportHTML += '                         </div>';
            }
            //    ReportHTML += '             <div class="col-xs-4"></div>';
    ...
    if (pOutputTo == "Excel") {
        ...
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            if (CurrentRows.length > 0) {
                ...
                if ($("#hDefaultUnEditableCompanyName").val() != "SAF" && $("#hDefaultUnEditableCompanyName").val() != "NIL" && $("#hDefaultUnEditableCompanyName").val() != "CFR" ) {
                    ReportHTML += ' <div class="col-xs-12" > All business is transacted  in accordance with our standard trading condition including the company`s liability </div>';
                    ReportHTML += ' <div class="col-xs-12" >and include jurisdiction place copy is available upon request </div>';
                }
...
function SubAccountLedger_Print_ClientStatmentEn_SEF(pData, pOutputTo) {
    debugger;
    var pSubAccountIDList = (glbCallingControl == "AccountStatement"
                            ? $("#slSubAccount").val()
                            : GetAllSelectedIDsAsStringWithNameAttr("nameCbSubAccount"));
    ...
    var pTblRowsGroupByCurrencySum = JSON.parse(pData[4]);
    var pTblRowsByCurrency = JSON.parse(pData[5]);
    var pTblClientStatment = JSON.parse(pData[11]);
    ...
    var pTablesHeaderHTML = "";
        ...
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            pTablesHTML += ' <tr> ';
            pTablesHTML += '                     <th class="col-xs-2">' + 'Date' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Shipper name' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'MAWB' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'HAWB' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Due Date' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Customer Reference' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Gross Weight' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Chargeable Weight' + '</th>';
            pTablesHTML += '                     <th style="width: 2px; class="col-xs-2">' + 'Reference No' + '</th>';
            pTablesHTML += '                     <th class="col-xs-4">' + 'Description' + '</th>';
            pTablesHTML += '                     <th class="col-xs-2">' + 'Debit' + '</th>';
            pTablesHTML += '                     <th class="col-xs-2">' + 'Credit' + '</th>';
            pTablesHTML += '                     <th class="col-xs-2">' + 'Balance' + '</th>';
            ...
            $.each(pTblClientStatment, function (i, item) {
                if (item.SubAccount_ID == ArrSubAccountIDList[j] && item.Currency_ID == CurrencyID) {
                    ...
                    pTablesHTML += '                 <tr class="" style="font-size:95%;">';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + (Date.prototype.compareDates("01/01/1900", GetDateWithFormatMDY(item.JVDate)) < 1 ? "" : ConvertDateFormat(GetDateWithFormatMDY(item.JVDate))) + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.ShipperName + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.MasterBL + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.HouseNumber + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + (Date.prototype.compareDates("01/01/1900", GetDateWithFormatMDY(item.DueDate)) < 1 ? "" : ConvertDateFormat(GetDateWithFormatMDY(item.DueDate))) + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.CustomerReference + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.GrossWeight + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.ChargeableWeight + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.OperationNotes + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="">' + item.InvoiceNo + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="Deb">' + item.Debit.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="Cre">' + item.Credit.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + '</td>';
                    pTablesHTML += '                     <td style="text-align:center;" class="FBalance">' + FBalance.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + '</td>';//FBalance
        ...
        for (var j = 0; j < ArrSubAccountIDList.length; j++) {
            ...
            var pRowTotalsHTML = "";
            pRowTotalsHTML += '                            <tr class="" style="font-size:95%;">';
            pRowTotalsHTML += '                                <td colspan="10" style="text-align:center;" class=""><b><u>' + 'Totals</u></b> &emsp;' + '</td>';
            ...
            pTablesHTML += '                 <tr class="" style="font-size:95%;">';
                pRowTotalsHTML += '                                <td colspan="10" style="text-align:center;" class=""><b>  Balance  </b>' + '</td>';
...
function SendAsEmail() {
    ...
    arr_Values.push($("#slSubAccount").val());
