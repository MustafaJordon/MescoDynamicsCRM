...
namespace Forwarding.MvcApp.Models.MasterData.Partners.Generated
{
    ...
    [Serializable]
    public partial class CVarTruckersTAX : CPKTruckersTAX
    {
        #region "variables"
    ...
    public partial class CTruckersTAX
    {
        #region "variables"
        ...
        public List<CVarTruckersTAX> lstCVarTruckers = new List<CVarTruckersTAX>();
        public List<CPKTruckersTAX> lstDeletedCPKTruckers = new List<CPKTruckersTAX>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListTruckersTax";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemTruckersTax";
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarTruckersTAX ObjCVarTruckers = new CVarTruckersTAX();
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListTruckersTax";
                else
                    Com.CommandText = "[dbo].UpdateListTruckersTax";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.VarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKTruckersTAX> DeleteList)
        {
            ...
            try
            {
                Con.Open();
                Com = new SqlCommand();
                Com.CommandText = "[dbo].DeleteItemTruckersTax";
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                foreach (CPKTruckersTAX ObjCPKTruckers in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarTruckersTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarTruckersTAX ObjCVarTruckers in SaveList)
                {
                    if (ObjCVarTruckers.mIsChanges == true)
                    {
                        if (ObjCVarTruckers.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemTruckersTax";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarTruckers.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemTruckersTax";
