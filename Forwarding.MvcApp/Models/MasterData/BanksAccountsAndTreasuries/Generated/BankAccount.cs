...
namespace Forwarding.MvcApp.Models.MasterData.BanksAccountsAndTreasuries.Generated
{
    ...
    [Serializable]
    public partial class CVarBankAccount : CPKBankAccount
    {
        #region "variables"
    ...
    public partial class CBankAccount
    {
        #region "variables"
        ...
        public List<CVarBankAccount> lstCVarBankAccount = new List<CVarBankAccount>();
        public List<CPKBankAccount> lstDeletedCPKBankAccount = new List<CPKBankAccount>();
        #endregion
        ...
        public Exception DeleteItem(List<CPKBankAccount> DeleteList)
        {
            ...
            try
            {
                Con.Open();
                Com = new SqlCommand();
                Com.CommandText = "[dbo].DeleteItemBankAccount";
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                foreach (CPKBankAccount ObjCPKBankAccount in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarBankAccount> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarBankAccount ObjCVarBankAccount in SaveList)
                {
                    if (ObjCVarBankAccount.mIsChanges == true)
                    {
                        if (ObjCVarBankAccount.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemBankAccount";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarBankAccount.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemBankAccount";
