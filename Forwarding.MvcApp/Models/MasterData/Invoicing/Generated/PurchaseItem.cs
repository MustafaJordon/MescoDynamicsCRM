...
namespace Forwarding.MvcApp.Models.MasterData.Invoicing.Generated
{
    ...
    [Serializable]
    public partial class CVarPurchaseItem : CPKPurchaseItem
    {
        #region "variables"
    ...
    public partial class CPurchaseItem
    {
        #region "variables"
        ...
        public List<CVarPurchaseItem> lstCVarPurchaseItem = new List<CVarPurchaseItem>();
        public List<CPKPurchaseItem> lstDeletedCPKPurchaseItem = new List<CPKPurchaseItem>();
        #endregion
        ...
        public Exception DeleteItem(List<CPKPurchaseItem> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKPurchaseItem ObjCPKPurchaseItem in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarPurchaseItem> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarPurchaseItem ObjCVarPurchaseItem in SaveList)
                {
                    if (ObjCVarPurchaseItem.mIsChanges == true)
                    {
                        if (ObjCVarPurchaseItem.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPurchaseItem";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarPurchaseItem.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemPurchaseItem";
