        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListvw_InvoiceHeaderDetailsYardLinkTankByInvoiceID";
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarvw_InvoiceHeaderDetailsYardByInvoiceID.mSalesTax = Convert.ToDecimal(dr["SalesTax"].ToString());
