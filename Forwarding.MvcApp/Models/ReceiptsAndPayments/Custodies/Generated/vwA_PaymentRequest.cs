...
{
    [Serializable]
    public partial class CVarvwA_PaymentRequest
    {
        #region "variables"
        ...
        internal String mPartenerID;
        internal String mPartenerTypeID;
        ...
        internal Int64 mChargeTypeGroupID;
        internal string mAttache;
        internal string mPayment;
        internal string mIssuedTo;
        internal Int64 mPaymentComboID;
        internal Int64 mIssuedToCmbo;
        ...
        public String PartenerTypeID
        {
            get { return mPartenerTypeID; }
            set { mPartenerTypeID = value; }
        }
        public String Code
        {
            get { return mCode; }
        ...
        public Int64 ChargeTypeGroupID
        {
        ...
        public Int64 PaymentComboID
        {
            get { return mPaymentComboID; }
            set { mPaymentComboID = value; }
        }
        public Int64 IssuedToCmbo
        {
            get { return mIssuedToCmbo; }
            set { mIssuedToCmbo = value; }
        }
    ...
    public partial class CvwA_PaymentRequest
    {
        #region "variables"
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListvwA_PaymentRequest";
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarvwA_PaymentRequest.mIsAccept = Convert.ToBoolean(dr["IsAccept"].ToString());
                        ...
                        ObjCVarvwA_PaymentRequest.mChargeTypeGroupID = Convert.ToInt32(dr["ChargeTypeGroupID"].ToString());
                        ObjCVarvwA_PaymentRequest.mAttache = Convert.ToString(dr["Attache"].ToString());
                        ObjCVarvwA_PaymentRequest.mPayment = Convert.ToString(dr["Payment"].ToString());
                        ObjCVarvwA_PaymentRequest.mIssuedTo = Convert.ToString(dr["IssuedTo"].ToString());
                        ObjCVarvwA_PaymentRequest.mPaymentComboID = Convert.ToInt32(dr["PaymentComboID"].ToString());
                        ObjCVarvwA_PaymentRequest.mIssuedToCmbo = Convert.ToInt32(dr["IssuedToCmbo"].ToString());
                        ObjCVarvwA_PaymentRequest.mPartnerID = Convert.ToInt32(dr["PartnerID"].ToString());
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.CommandText = "[dbo].GetListPagingvwA_PaymentRequest";
