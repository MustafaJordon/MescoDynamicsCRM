...
namespace Forwarding.MvcApp.Models.ReceiptsAndPayments.Transactions.Generated
{
    ...
    [Serializable]
    public partial class CVarA_Voucher : CPKA_Voucher
    {
        #region "variables"
    ...
    public partial class CA_Voucher
    {
        #region "variables"
        ...
        public List<CVarA_Voucher> lstCVarA_Voucher = new List<CVarA_Voucher>();
        public List<CPKA_Voucher> lstDeletedCPKA_Voucher = new List<CPKA_Voucher>();
        #endregion
        ...
        public Exception DeleteItem(List<CPKA_Voucher> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_Voucher ObjCPKA_Voucher in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_Voucher> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarA_Voucher ObjCVarA_Voucher in SaveList)
                {
