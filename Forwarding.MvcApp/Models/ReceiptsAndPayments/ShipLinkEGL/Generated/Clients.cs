...
namespace Forwarding.MvcApp.Models.ReceiptsAndPayments.ShipLinkEGL.Generated
{
    ...
    public partial class CVarSL_Clients : CPKSL_Clients
    {
        ...
        internal String mTaxCard;
        internal String mCommercialRegistration;
        internal Int32 mPaymentBankID;
        #endregion
        ...
        {
            get { return mTaxCard; }
            set { mIsChanges = true; mTaxCard = value; }
        }
        public String CommercialRegistration
        {
            get { return mCommercialRegistration; }
            set { mIsChanges = true; mCommercialRegistration = value; }
        }
        public Int32 PaymentBankID
        {
            get { return mPaymentBankID; }
            set { mIsChanges = true; mPaymentBankID = value; }
        }
        #endregion
    ...
    public partial class CSL_Clients
    {
            ...
            try
            {
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarSL_Clients.mAccountID = Convert.ToInt32(dr["AccountID"].ToString());
                        ObjCVarSL_Clients.mSubAccountID = Convert.ToInt32(dr["SubAccountID"].ToString());
                        ObjCVarSL_Clients.mSubAccountGroupID = Convert.ToInt32(dr["SubAccountGroupID"].ToString());
                        ObjCVarSL_Clients.mTaxCard = Convert.ToString(dr["TaxCard"].ToString());
                        ObjCVarSL_Clients.mCommercialRegistration = Convert.ToString(dr["CommercialRegistration"].ToString());
                        ObjCVarSL_Clients.mPaymentBankID = Convert.ToInt32(dr["PaymentBankID"].ToString());
        ...
        public Exception SaveMethod(List<CVarSL_Clients> SaveList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@TaxCard", SqlDbType.VarChar));
                Com.Parameters.Add(new SqlParameter("@CommercialRegistration", SqlDbType.NVarChar));
                Com.Parameters.Add(new SqlParameter("@PaymentBankID", SqlDbType.Int));
                ...
                foreach (CVarSL_Clients ObjCVarSL_Clients in SaveList)
                {
                    if (ObjCVarSL_Clients.mIsChanges == true)
                    {
                        ...
                        Com.Parameters["@AccountID"].Value = ObjCVarSL_Clients.AccountID;
                        Com.Parameters["@SubAccountID"].Value = ObjCVarSL_Clients.SubAccountID;
                        Com.Parameters["@SubAccountGroupID"].Value = ObjCVarSL_Clients.SubAccountGroupID;
                        Com.Parameters["@TaxCard"].Value = ObjCVarSL_Clients.TaxCard;
                        Com.Parameters["@CommercialRegistration"].Value = ObjCVarSL_Clients.CommercialRegistration;
                        Com.Parameters["@PaymentBankID"].Value = ObjCVarSL_Clients.PaymentBankID;
                        EndTrans(Com, Con);
                        if (ObjCVarSL_Clients.ID == 0)
                        {
