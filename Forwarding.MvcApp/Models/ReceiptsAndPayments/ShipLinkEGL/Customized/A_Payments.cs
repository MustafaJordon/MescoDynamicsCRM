...
namespace Forwarding.MvcApp.Models.ReceiptsAndPayments.ShipLinkEGL.Customized
{
    public static class GlobalConnectionEGL
    {
        ...
        public static bool CreateConnectionEGL()
        {
    ...
    [Serializable]
    public partial class CVarA_PaymentsEGL : CPKA_PaymentsEGL
    {
        #region "variables"
    ...
    public partial class CA_PaymentsEGL
    {
        #region "variables"
        ...
        public List<CVarA_PaymentsEGL> lstCVarA_Payments = new List<CVarA_PaymentsEGL>();
        public List<CPKA_PaymentsEGL> lstDeletedCPKA_Payments = new List<CPKA_PaymentsEGL>();
        #endregion
        ...
        public Exception DeleteItem(List<CPKA_PaymentsEGL> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_PaymentsEGL ObjCPKA_Payments in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_PaymentsEGL> SaveList)
        {
            //GlobalConnectionEGL.OpenConnection();
            Exception Exp = null;
            //GlobalConnectionEGL.GlobalCon = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            //SqlCommand Com;// = GlobalConnectionEGL.GlobalCom;
            try
            {
               // GlobalConnectionEGL.myTrans = GlobalConnectionEGL.myConnection.BeginTransaction(IsolationLevel.ReadUncommitted);
                GlobalConnectionEGL.myCommand = new SqlCommand();

                GlobalConnectionEGL.myCommand.Connection = GlobalConnectionEGL.myConnection;
                GlobalConnectionEGL.myCommand.Transaction = GlobalConnectionEGL.myTrans;
                //GlobalConnectionEGL.myCommand.CommandTimeout = 0;
                GlobalConnectionEGL.myCommand.CommandType = CommandType.StoredProcedure;

                //GlobalConnectionEGL.GlobalCon.Open();
                //Com = new SqlCommand();
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@Code", SqlDbType.NVarChar));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@PaymentDate", SqlDbType.DateTime));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@ClientID", SqlDbType.BigInt));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@Notes", SqlDbType.NVarChar));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@UserID", SqlDbType.Int));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@IsDeleted", SqlDbType.Bit));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@TotalCost", SqlDbType.NVarChar));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@PaymentCurrencyID", SqlDbType.Int));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@PaymentAmount", SqlDbType.Decimal));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@PaymentExchangeRate", SqlDbType.Decimal));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@BankChargesAmount", SqlDbType.Decimal));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@BankChargesCurrencyID", SqlDbType.Int));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@RefundAmount", SqlDbType.Decimal));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@RefundCurrencyID", SqlDbType.Int));
                GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@isExtra", SqlDbType.Bit));


                SqlParameter paraID = GlobalConnectionEGL.myCommand.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarA_PaymentsEGL ObjCVarA_Payments in SaveList)
                {
                    if (ObjCVarA_Payments.mIsChanges == true)
                    {
                        if (ObjCVarA_Payments.ID == 0)
                        {
                            GlobalConnectionEGL.myCommand.CommandText = "[dbo].InsertItemA_Payments";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarA_Payments.ID != 0)
                        {
                            GlobalConnectionEGL.myCommand.CommandText = "[dbo].UpdateItemA_Payments";
                            paraID.Direction = ParameterDirection.Input;
                        }
                        /////////////
                        //BeginTrans(Com, GlobalConnectionEGL.GlobalCon);
                        //////////////
                        if (ObjCVarA_Payments.ID != 0)
                        {
                            GlobalConnectionEGL.myCommand.Parameters["@ID"].Value = ObjCVarA_Payments.ID;
                        }
                        GlobalConnectionEGL.myCommand.Parameters["@Code"].Value = ObjCVarA_Payments.Code;
                        GlobalConnectionEGL.myCommand.Parameters["@PaymentDate"].Value = ObjCVarA_Payments.PaymentDate;
                        GlobalConnectionEGL.myCommand.Parameters["@ClientID"].Value = ObjCVarA_Payments.ClientID;
                        GlobalConnectionEGL.myCommand.Parameters["@Notes"].Value = ObjCVarA_Payments.Notes;
                        GlobalConnectionEGL.myCommand.Parameters["@UserID"].Value = ObjCVarA_Payments.UserID;
                        GlobalConnectionEGL.myCommand.Parameters["@IsDeleted"].Value = ObjCVarA_Payments.IsDeleted;
                        GlobalConnectionEGL.myCommand.Parameters["@TotalCost"].Value = ObjCVarA_Payments.TotalCost;
                        GlobalConnectionEGL.myCommand.Parameters["@PaymentCurrencyID"].Value = ObjCVarA_Payments.PaymentCurrencyID;
                        GlobalConnectionEGL.myCommand.Parameters["@PaymentAmount"].Value = ObjCVarA_Payments.PaymentAmount;
                        GlobalConnectionEGL.myCommand.Parameters["@PaymentExchangeRate"].Value = ObjCVarA_Payments.PaymentExchangeRate;
                        GlobalConnectionEGL.myCommand.Parameters["@BankChargesAmount"].Value = ObjCVarA_Payments.BankChargesAmount;
                        GlobalConnectionEGL.myCommand.Parameters["@BankChargesCurrencyID"].Value = ObjCVarA_Payments.BankChargesCurrency;
                        GlobalConnectionEGL.myCommand.Parameters["@RefundAmount"].Value = ObjCVarA_Payments.RefundAmount;
                        GlobalConnectionEGL.myCommand.Parameters["@RefundCurrencyID"].Value = ObjCVarA_Payments.RefundCurrency;
                        GlobalConnectionEGL.myCommand.Parameters["@isExtra"].Value = ObjCVarA_Payments.isExtra;


                        //EndTrans(Com, GlobalConnectionEGL.GlobalCon);
                        GlobalConnectionEGL.myCommand.ExecuteNonQuery();
                 
                        //GlobalConnectionEGL.myTrans.Commit();
                        if (ObjCVarA_Payments.ID == 0)
                        {
                            ObjCVarA_Payments.ID = Convert.ToInt64(GlobalConnectionEGL.myCommand.Parameters["@ID"].Value);
                        }
            ...
            catch (Exception ex)
            {
                ...
                //if (tr != null)
                //    tr.Rollback();
                //GlobalConnectionEGL.transaction.Rollback();
    ...
    [Serializable]
    public class CPKA_VoucherPaymentsEGL
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarA_VoucherPaymentsEGL : CPKA_VoucherPaymentsEGL
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CA_VoucherPaymentsEGL
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarA_VoucherPaymentsEGL> lstCVarA_VoucherPayments = new List<CVarA_VoucherPaymentsEGL>();
        public List<CPKA_VoucherPaymentsEGL> lstDeletedCPKA_VoucherPayments = new List<CPKA_VoucherPaymentsEGL>();
        #endregion
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKA_VoucherPaymentsEGL> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_VoucherPaymentsEGL ObjCPKA_VoucherPayments in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_VoucherPaymentsEGL> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnectionEGL.GlobalCom;
            try
            {
                ...
                GlobalConnectionEGL.myCommand.CommandType = CommandType.StoredProcedure;
                //GlobalConnectionEGL.myCommand.CommandTimeout = 120;
                Com = GlobalConnectionEGL.myCommand;
               ...
               // Com.Parameters.Add(new SqlParameter("@VoucherCode", SqlDbType.NVarChar));
                ...
                foreach (CVarA_VoucherPaymentsEGL ObjCVarA_VoucherPayments in SaveList)
                {
    ...
    [Serializable]
    public class CPKA_PaymentInvoicesEGL
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarA_PaymentInvoicesEGL : CPKA_PaymentInvoicesEGL
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CA_PaymentInvoicesEGL
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarA_PaymentInvoicesEGL> lstCVarA_PaymentInvoices = new List<CVarA_PaymentInvoicesEGL>();
        public List<CPKA_PaymentInvoicesEGL> lstDeletedCPKA_PaymentInvoices = new List<CPKA_PaymentInvoicesEGL>();
        #endregion
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKA_PaymentInvoicesEGL> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_PaymentInvoicesEGL ObjCPKA_PaymentInvoices in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_PaymentInvoicesEGL> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnectionEGL.GlobalCom;
            try
            {
                ...
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarA_PaymentInvoicesEGL ObjCVarA_PaymentInvoices in SaveList)
                {
    ...
    [Serializable]
    public class CPKA_VoucherHeaderEGL
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarA_VoucherHeaderEGL : CPKA_VoucherHeaderEGL
    {
        #region "variables"
        internal Boolean mIsChanges = false;
        internal String mCode;
    ...
    public partial class CA_VoucherHeaderEGL
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarA_VoucherHeaderEGL> lstCVarA_Voucher = new List<CVarA_VoucherHeaderEGL>();
        public List<CPKA_VoucherHeaderEGL> lstDeletedCPKA_Voucher = new List<CPKA_VoucherHeaderEGL>();
        #endregion
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKA_VoucherHeaderEGL> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_VoucherHeaderEGL ObjCPKA_Voucher in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_VoucherHeaderEGL> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnectionEGL.GlobalCom;
            ...
            try
            {
                ...
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarA_VoucherHeaderEGL ObjCVarA_Voucher in SaveList)
                {
                    if (ObjCVarA_Voucher.mIsChanges == true)
                    {
                        ...
                        //EndTrans(GlobalConnectionEGL.GlobalCom, GlobalConnectionEGL.GlobalCon);
                        Com.ExecuteNonQuery();
                        //GlobalConnectionEGL.myTrans.Commit();
                        if (ObjCVarA_Voucher.ID == 0)
                        {
    ...
    [Serializable]
    public class CPKA_VoucherHeaderDetailsEGL
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarA_VoucherHeaderDetailsEGL : CPKA_VoucherHeaderDetailsEGL
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CA_VoucherHeaderDetailsEGL
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarA_VoucherHeaderDetailsEGL> lstCVarA_VoucherDetails = new List<CVarA_VoucherHeaderDetailsEGL>();
        public List<CPKA_VoucherHeaderDetailsEGL> lstDeletedCPKA_VoucherDetails = new List<CPKA_VoucherHeaderDetailsEGL>();
        #endregion
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKA_VoucherHeaderDetailsEGL> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_VoucherHeaderDetailsEGL ObjCPKA_VoucherDetails in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_VoucherHeaderDetailsEGL> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnectionEGL.GlobalCom;
            try
            {
                ...
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarA_VoucherHeaderDetailsEGL ObjCVarA_VoucherDetails in SaveList)
                {
    ...
    public class CPaymentsCustomizedDBCallEGL
    {
        ...
        public Exception CallStringFunction(string pStrQuery)
        {
            ...
            try
            {
                ...
                GlobalConnectionEGL.myCommand = new SqlCommand(pStrQuery, GlobalConnectionEGL.myConnection, GlobalConnectionEGL.myTrans);
        ...
        public string CallStringFunctionReturn(string pStrQuery)
        {
            ...
            try
            {
                ...
                dr = GlobalConnectionEGL.myCommand.ExecuteReader();
                try
                {
                    while (dr.Read())
                    {
