...
{
    [Serializable]
    public class CPKPurchaseInvoice_OpeningBalance
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarPurchaseInvoice_OpeningBalance : CPKPurchaseInvoice_OpeningBalance
    {
        #region "variables"
    ...
    public partial class CPurchaseInvoice_OpeningBalance
    {
        #region "variables"
        ...
        public List<CVarPurchaseInvoice_OpeningBalance> lstCVarPurchaseInvoice_OpeningBalance = new List<CVarPurchaseInvoice_OpeningBalance>();
        public List<CPKPurchaseInvoice_OpeningBalance> lstDeletedCPKPurchaseInvoice_OpeningBalance = new List<CPKPurchaseInvoice_OpeningBalance>();
        #endregion
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                if (IsDelete == true)
                    ...
                    Com.CommandText = "[dbo].UpdateListPurchaseInvoice_OpeningBalance";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKPurchaseInvoice_OpeningBalance> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKPurchaseInvoice_OpeningBalance ObjCPKPurchaseInvoice_OpeningBalance in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarPurchaseInvoice_OpeningBalance> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarPurchaseInvoice_OpeningBalance ObjCVarPurchaseInvoice_OpeningBalance in SaveList)
                {
                    if (ObjCVarPurchaseInvoice_OpeningBalance.mIsChanges == true)
                    {
                        if (ObjCVarPurchaseInvoice_OpeningBalance.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPurchaseInvoice_OpeningBalance";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarPurchaseInvoice_OpeningBalance.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemPurchaseInvoice_OpeningBalance";
