...
{
    [Serializable]
    public class CPKPurchaseInvoiceItem_OpeningBalanceTax
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarPurchaseInvoiceItem_OpeningBalanceTax : CPKPurchaseInvoiceItem_OpeningBalanceTax
    {
        #region "variables"
    ...
    public partial class CPurchaseInvoiceItem_OpeningBalanceTax
    {
        #region "variables"
        ...
        public List<CVarPurchaseInvoiceItem_OpeningBalanceTax> lstCVarPurchaseInvoiceItem_OpeningBalance = new List<CVarPurchaseInvoiceItem_OpeningBalanceTax>();
        public List<CPKPurchaseInvoiceItem_OpeningBalanceTax> lstDeletedCPKPurchaseInvoiceItem_OpeningBalance = new List<CPKPurchaseInvoiceItem_OpeningBalanceTax>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarPurchaseInvoiceItem_OpeningBalanceTax ObjCVarPurchaseInvoiceItem_OpeningBalance = new CVarPurchaseInvoiceItem_OpeningBalanceTax();
        ...
        public Exception DeleteItem(List<CPKPurchaseInvoiceItem_OpeningBalanceTax> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKPurchaseInvoiceItem_OpeningBalanceTax ObjCPKPurchaseInvoiceItem_OpeningBalance in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarPurchaseInvoiceItem_OpeningBalanceTax> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarPurchaseInvoiceItem_OpeningBalanceTax ObjCVarPurchaseInvoiceItem_OpeningBalance in SaveList)
                {
                    if (ObjCVarPurchaseInvoiceItem_OpeningBalance.mIsChanges == true)
                    {
                        if (ObjCVarPurchaseInvoiceItem_OpeningBalance.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPurchaseInvoiceItem_OpeningBalanceTax";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarPurchaseInvoiceItem_OpeningBalance.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemPurchaseInvoiceItem_OpeningBalanceTax";
