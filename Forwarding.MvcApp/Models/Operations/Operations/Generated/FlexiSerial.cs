...
namespace Forwarding.MvcApp.Models.Operations.Operations.Generated
{
    ...
    [Serializable]
    public partial class CVarFlexiSerial : CPKFlexiSerial
    {
        #region "variables"
    ...
    public partial class CFlexiSerial
    {
        #region "variables"
        ...
        public List<CVarFlexiSerial> lstCVarFlexiSerial = new List<CVarFlexiSerial>();
        public List<CPKFlexiSerial> lstDeletedCPKFlexiSerial = new List<CPKFlexiSerial>();
        #endregion
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListFlexiSerial";
                else
                    Com.CommandText = "[dbo].UpdateListFlexiSerial";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKFlexiSerial> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKFlexiSerial ObjCPKFlexiSerial in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarFlexiSerial> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarFlexiSerial ObjCVarFlexiSerial in SaveList)
                {
                    if (ObjCVarFlexiSerial.mIsChanges == true)
                    {
                        if (ObjCVarFlexiSerial.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemFlexiSerial";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarFlexiSerial.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemFlexiSerial";
