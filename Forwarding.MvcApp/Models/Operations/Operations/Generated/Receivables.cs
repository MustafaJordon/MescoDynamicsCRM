...
namespace Forwarding.MvcApp.Models.Operations.Operations.Generated
{
    ...
    [Serializable]
    public partial class CVarReceivables : CPKReceivables
    {
        #region "variables"
        ...
        public DateTime ReceiptDate
        {
            ...
            set { mIsChanges = true; mReceiptDate = value; }
        }
        #endregion
    ...
    public partial class CReceivables
    {
        #region "variables"
        ...
        public List<CVarReceivables> lstCVarReceivables = new List<CVarReceivables>();
        public List<CPKReceivables> lstDeletedCPKReceivables = new List<CPKReceivables>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListReceivables";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemReceivables";
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarReceivables.mInvoiceID_3PL = Convert.ToInt64(dr["InvoiceID_3PL"].ToString());
                        ObjCVarReceivables.mSalePrice_Foreign = Convert.ToDecimal(dr["SalePrice_Foreign"].ToString());
                        ObjCVarReceivables.mCurrencyID_Foreign = Convert.ToInt32(dr["CurrencyID_Foreign"].ToString());
                        ObjCVarReceivables.mExchangeRate_Foreign = Convert.ToDecimal(dr["ExchangeRate_Foreign"].ToString());
                        ObjCVarReceivables.mReceiptNo = Convert.ToString(dr["ReceiptNo"].ToString());
                        ObjCVarReceivables.mReceiptDate = Convert.ToDateTime(dr["ReceiptDate"].ToString());
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListReceivables";
                else
                    Com.CommandText = "[dbo].UpdateListReceivables";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKReceivables> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKReceivables ObjCPKReceivables in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarReceivables> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@InvoiceID_3PL", SqlDbType.BigInt));
                Com.Parameters.Add(new SqlParameter("@SalePrice_Foreign", SqlDbType.Decimal));
                Com.Parameters.Add(new SqlParameter("@CurrencyID_Foreign", SqlDbType.Int));
                Com.Parameters.Add(new SqlParameter("@ExchangeRate_Foreign", SqlDbType.Decimal));
                Com.Parameters.Add(new SqlParameter("@ReceiptNo", SqlDbType.NVarChar));
                Com.Parameters.Add(new SqlParameter("@ReceiptDate", SqlDbType.DateTime));
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarReceivables ObjCVarReceivables in SaveList)
                {
                    if (ObjCVarReceivables.mIsChanges == true)
                    {
                        if (ObjCVarReceivables.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemReceivables";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarReceivables.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemReceivables";
                        ...
                        Com.Parameters["@InvoiceID_3PL"].Value = ObjCVarReceivables.InvoiceID_3PL;
                        Com.Parameters["@SalePrice_Foreign"].Value = ObjCVarReceivables.SalePrice_Foreign;
                        Com.Parameters["@CurrencyID_Foreign"].Value = ObjCVarReceivables.CurrencyID_Foreign;
                        Com.Parameters["@ExchangeRate_Foreign"].Value = ObjCVarReceivables.ExchangeRate_Foreign;
                        Com.Parameters["@ReceiptNo"].Value = ObjCVarReceivables.ReceiptNo;
                        Com.Parameters["@ReceiptDate"].Value = ObjCVarReceivables.ReceiptDate;
                        EndTrans(Com, Con);
                        if (ObjCVarReceivables.ID == 0)
                        {
