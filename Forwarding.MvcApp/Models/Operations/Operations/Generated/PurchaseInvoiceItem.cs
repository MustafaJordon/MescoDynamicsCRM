...
{
    [Serializable]
    public class CPKPurchaseInvoiceItem
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarPurchaseInvoiceItem : CPKPurchaseInvoiceItem
    {
        #region "variables"
    ...
    public partial class CPurchaseInvoiceItem
    {
        #region "variables"
        ...
        public List<CVarPurchaseInvoiceItem> lstCVarPurchaseInvoiceItem = new List<CVarPurchaseInvoiceItem>();
        public List<CPKPurchaseInvoiceItem> lstDeletedCPKPurchaseInvoiceItem = new List<CPKPurchaseInvoiceItem>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListPurchaseInvoiceItem";
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                if (IsDelete == true)
                    ...
                    Com.CommandText = "[dbo].UpdateListPurchaseInvoiceItem";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKPurchaseInvoiceItem> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKPurchaseInvoiceItem ObjCPKPurchaseInvoiceItem in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarPurchaseInvoiceItem> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarPurchaseInvoiceItem ObjCVarPurchaseInvoiceItem in SaveList)
                {
                    if (ObjCVarPurchaseInvoiceItem.mIsChanges == true)
                    {
                        if (ObjCVarPurchaseInvoiceItem.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPurchaseInvoiceItem";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarPurchaseInvoiceItem.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemPurchaseInvoiceItem";
