...
{
    [Serializable]
    public class CPKOperationContainersAndPackages
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarOperationContainersAndPackages : CPKOperationContainersAndPackages
    {
        #region "variables"
    ...
    public partial class COperationContainersAndPackages
    {
        #region "variables"
        ...
        public List<CVarOperationContainersAndPackages> lstCVarOperationContainersAndPackages = new List<CVarOperationContainersAndPackages>();
        public List<CPKOperationContainersAndPackages> lstDeletedCPKOperationContainersAndPackages = new List<CPKOperationContainersAndPackages>();
        #endregion
            ...
            try
            {
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarOperationContainersAndPackages.mNetWeightTON = Convert.ToDecimal(dr["NetWeightTON"].ToString());
                        ObjCVarOperationContainersAndPackages.mGrossWeightTON = Convert.ToDecimal(dr["GrossWeightTON"].ToString());
        ...
        public Exception DeleteItem(List<CPKOperationContainersAndPackages> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKOperationContainersAndPackages ObjCPKOperationContainersAndPackages in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarOperationContainersAndPackages> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarOperationContainersAndPackages ObjCVarOperationContainersAndPackages in SaveList)
                {
                    if (ObjCVarOperationContainersAndPackages.mIsChanges == true)
                    {
                        if (ObjCVarOperationContainersAndPackages.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemOperationContainersAndPackages";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarOperationContainersAndPackages.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemOperationContainersAndPackages";
                        ...
                        Com.Parameters["@NetWeightTON"].Value = ObjCVarOperationContainersAndPackages.NetWeightTON;
                        Com.Parameters["@GrossWeightTON"].Value = ObjCVarOperationContainersAndPackages.GrossWeightTON;
                        EndTrans(Com, Con);
                        if (ObjCVarOperationContainersAndPackages.ID == 0)
                        {
