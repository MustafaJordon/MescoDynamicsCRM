...
namespace Forwarding.MvcApp.Models.Sales.Transactions.Generated.Payments.Generated
{
    ...
    [Serializable]
    public partial class CVarA_Payments : CPKSL_Payments
    {
        #region "variables"
        ...
        public Decimal TotalPayment
        {
            ...
            set { mIsChanges = true; mTotalPayment = value; }
        }
        public Int64 JVID
        {
            get { return mJVID; }
        ...
        public Int32 RefundCurrencyID
        {
            ...
            set { mIsChanges = true; mRefundCurrencyID = value; }
        }
        ...
        public Int32 BankChargesCurrencyID
        {
            ...
            set { mIsChanges = true; mBankChargesCurrencyID = value; }
        }
        #endregion
    ...
    public partial class CSL_Payments
    {
        #region "variables"
        ...
        public List<CVarSL_Payments> lstCVarSL_Payments = new List<CVarSL_Payments>();
        public List<CPKSL_Payments> lstDeletedCPKSL_Payments = new List<CPKSL_Payments>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListPayments";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemPayments";
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarSL_Payments.ID = Convert.ToInt64(dr["ID"].ToString());
                        ObjCVarSL_Payments.mCode = Convert.ToString(dr["Code"].ToString());
                        ObjCVarSL_Payments.mPaymentDate = Convert.ToDateTime(dr["PaymentDate"].ToString());
                        ObjCVarSL_Payments.mClientID = Convert.ToInt64(dr["ClientID"].ToString());
                        ObjCVarSL_Payments.mNotes = Convert.ToString(dr["Notes"].ToString());
                        ObjCVarSL_Payments.mUserID = Convert.ToInt32(dr["UserID"].ToString());
                        ObjCVarSL_Payments.mIsDeleted = Convert.ToBoolean(dr["IsDeleted"].ToString());
                        ObjCVarSL_Payments.mCurrencyID = Convert.ToInt32(dr["CurrencyID"].ToString());
                        ObjCVarSL_Payments.mTotalPayment = Convert.ToDecimal(dr["TotalPayment"].ToString());
                        ObjCVarSL_Payments.mJVID = Convert.ToInt64(dr["JVID"].ToString());
                        ObjCVarSL_Payments.mExchangeRate = Convert.ToDecimal(dr["ExchangeRate"].ToString());
                        ObjCVarSL_Payments.mRefundAmount = Convert.ToDecimal(dr["RefundAmount"].ToString());
                        ObjCVarSL_Payments.mRefundCurrencyID = Convert.ToInt32(dr["RefundCurrencyID"].ToString());
                        ObjCVarSL_Payments.mBankChargesAmount = Convert.ToDecimal(dr["BankChargesAmount"].ToString());
                        ObjCVarSL_Payments.mBankChargesCurrencyID = Convert.ToInt32(dr["BankChargesCurrencyID"].ToString());
                        lstCVarSL_Payments.Add(ObjCVarSL_Payments);
                    }
                }
                catch (Exception ex)
                {
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.CommandText = "[dbo].GetListPagingPayments";
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListPayments";
                else
                    Com.CommandText = "[dbo].UpdateListPayments";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKSL_Payments> DeleteList)
        {
            ...
            try
            {
                Con.Open();
                Com = new SqlCommand();
                Com.CommandText = "[dbo].DeleteItemPayments";
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKSL_Payments ObjCPKSL_Payments in DeleteList)
                {
                    BeginTrans(Com, Con);
                    Com.Parameters[0].Value = Convert.ToInt64(ObjCPKSL_Payments.ID);
                    EndTrans(Com, Con);
                }
            }
            catch (Exception ex)
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarSL_Payments> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@TotalPayment", SqlDbType.Decimal));
                ...
                Com.Parameters.Add(new SqlParameter("@RefundAmount", SqlDbType.Decimal));
                Com.Parameters.Add(new SqlParameter("@RefundCurrencyID", SqlDbType.Int));
                Com.Parameters.Add(new SqlParameter("@BankChargesAmount", SqlDbType.Decimal));
                Com.Parameters.Add(new SqlParameter("@BankChargesCurrencyID", SqlDbType.Int));
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarSL_Payments ObjCVarSL_Payments in SaveList)
                {
                    if (ObjCVarSL_Payments.mIsChanges == true)
                    {
                        if (ObjCVarSL_Payments.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPayments";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarSL_Payments.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemPayments";
                            paraID.Direction = ParameterDirection.Input;
                        }
                        // BeginTrans(Com, Con);
                        if (ObjCVarSL_Payments.ID != 0)
                        {
                            Com.Parameters["@ID"].Value = ObjCVarSL_Payments.ID;
                        }
                        Com.Parameters["@Code"].Value = ObjCVarSL_Payments.Code;
                        Com.Parameters["@PaymentDate"].Value = ObjCVarSL_Payments.PaymentDate;
                        Com.Parameters["@ClientID"].Value = ObjCVarSL_Payments.ClientID;
                        Com.Parameters["@Notes"].Value = ObjCVarSL_Payments.Notes;
                        Com.Parameters["@UserID"].Value = ObjCVarSL_Payments.UserID;
                        Com.Parameters["@IsDeleted"].Value = ObjCVarSL_Payments.IsDeleted;
                        Com.Parameters["@CurrencyID"].Value = ObjCVarSL_Payments.CurrencyID;
                        Com.Parameters["@TotalPayment"].Value = ObjCVarSL_Payments.TotalPayment;
                        Com.Parameters["@JVID"].Value = ObjCVarSL_Payments.JVID;
                        Com.Parameters["@ExchangeRate"].Value = ObjCVarSL_Payments.ExchangeRate;
                        Com.Parameters["@RefundAmount"].Value = ObjCVarSL_Payments.RefundAmount;
                        Com.Parameters["@RefundCurrencyID"].Value = ObjCVarSL_Payments.RefundCurrencyID;
                        Com.Parameters["@BankChargesAmount"].Value = ObjCVarSL_Payments.BankChargesAmount;
                        Com.Parameters["@BankChargesCurrencyID"].Value = ObjCVarSL_Payments.BankChargesCurrencyID;
                        Com.ExecuteNonQuery();
                        if (ObjCVarSL_Payments.ID == 0)
                        {
                            ObjCVarSL_Payments.ID = Convert.ToInt64(Com.Parameters["@ID"].Value);
                        }
                        ObjCVarSL_Payments.mIsChanges = false;
                    }
                }
            }
            catch (Exception ex)
        ...
        public Exception SaveA_JVAndA_JVDetails(Int32 pPaymentID)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnection.GlobalCom;
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@PaymentID", SqlDbType.NVarChar));

                //foreach (CVarA_Payments ObjCVarA_Payments in SaveList)
                //{

                Com.CommandText = "[dbo].A_Payments_Posting";

                //BeginTrans(Com, Con);

                Com.Parameters["@PaymentID"].Value = pPaymentID;
    ...
    [Serializable]
    public class CPKSL_VoucherPayments
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarSL_VoucherPayments : CPKSL_VoucherPayments
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CSL_VoucherPayments
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarSL_VoucherPayments> lstCVarSL_VoucherPayments = new List<CVarSL_VoucherPayments>();
        public List<CPKSL_VoucherPayments> lstDeletedCPKSL_VoucherPayments = new List<CPKSL_VoucherPayments>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            SqlCommand Com;
            SqlDataReader dr;
            lstCVarSL_VoucherPayments.Clear();
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarSL_VoucherPayments ObjCVarSL_VoucherPayments = new CVarSL_VoucherPayments();
                        ObjCVarSL_VoucherPayments.ID = Convert.ToInt64(dr["ID"].ToString());
                        ObjCVarSL_VoucherPayments.mSafeID = Convert.ToInt32(dr["SafeID"].ToString());
                        ObjCVarSL_VoucherPayments.mBankID = Convert.ToInt32(dr["BankID"].ToString());
                        ObjCVarSL_VoucherPayments.mvoucherCode = Convert.ToString(dr["voucherCode"].ToString());
                        ObjCVarSL_VoucherPayments.mCurrencyID = Convert.ToInt32(dr["CurrencyID"].ToString());
                        ObjCVarSL_VoucherPayments.mExchangeRate = Convert.ToDecimal(dr["ExchangeRate"].ToString());
                        ObjCVarSL_VoucherPayments.mAmount = Convert.ToDecimal(dr["Amount"].ToString());
                        ObjCVarSL_VoucherPayments.mNotes = Convert.ToString(dr["Notes"].ToString());
                        ObjCVarSL_VoucherPayments.mChequeNo = Convert.ToString(dr["ChequeNo"].ToString());
                        ObjCVarSL_VoucherPayments.mChequeDate = Convert.ToDateTime(dr["ChequeDate"].ToString());
                        ObjCVarSL_VoucherPayments.mVoucherType = Convert.ToInt32(dr["VoucherType"].ToString());
                        ObjCVarSL_VoucherPayments.mIsCheque = Convert.ToBoolean(dr["IsCheque"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxID = Convert.ToInt32(dr["TaxID"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxValue = Convert.ToDecimal(dr["TaxValue"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxSign = Convert.ToInt32(dr["TaxSign"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxID2 = Convert.ToInt32(dr["TaxID2"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxValue2 = Convert.ToDecimal(dr["TaxValue2"].ToString());
                        ObjCVarSL_VoucherPayments.mTaxSign2 = Convert.ToInt32(dr["TaxSign2"].ToString());
                        ObjCVarSL_VoucherPayments.mDiscountTaxID = Convert.ToInt32(dr["DiscountTaxID"].ToString());
                        ObjCVarSL_VoucherPayments.mDiscountTaxValue = Convert.ToDecimal(dr["DiscountTaxValue"].ToString());
                        ObjCVarSL_VoucherPayments.mDiscountTaxID2 = Convert.ToInt32(dr["DiscountTaxID2"].ToString());
                        ObjCVarSL_VoucherPayments.mDiscountTaxValue2 = Convert.ToDecimal(dr["DiscountTaxValue2"].ToString());
                        ObjCVarSL_VoucherPayments.mVoucherID = Convert.ToInt64(dr["VoucherID"].ToString());
                        ObjCVarSL_VoucherPayments.mPaymentID = Convert.ToInt64(dr["PaymentID"].ToString());
                        lstCVarSL_VoucherPayments.Add(ObjCVarSL_VoucherPayments);
                    }
                }
                catch (Exception ex)
                {
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKSL_VoucherPayments> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKSL_VoucherPayments ObjCPKSL_VoucherPayments in DeleteList)
                {
                    BeginTrans(Com, Con);
                    Com.Parameters[0].Value = Convert.ToInt64(ObjCPKSL_VoucherPayments.ID);
                    EndTrans(Com, Con);
                }
            }
            catch (Exception ex)
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarSL_VoucherPayments> SaveList)
        {
            Exception Exp = null;
            // SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarSL_VoucherPayments ObjCVarSL_VoucherPayments in SaveList)
                {
                    if (ObjCVarSL_VoucherPayments.mIsChanges == true)
                    {
                        if (ObjCVarSL_VoucherPayments.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemVoucherPayments";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarSL_VoucherPayments.ID != 0)
                        {
                        ...
                        if (ObjCVarSL_VoucherPayments.ID != 0)
                        {
                            Com.Parameters["@ID"].Value = ObjCVarSL_VoucherPayments.ID;
                        }
                        Com.Parameters["@SafeID"].Value = ObjCVarSL_VoucherPayments.SafeID;
                        Com.Parameters["@BankID"].Value = ObjCVarSL_VoucherPayments.BankID;
                        Com.Parameters["@voucherCode"].Value = ObjCVarSL_VoucherPayments.voucherCode;
                        Com.Parameters["@CurrencyID"].Value = ObjCVarSL_VoucherPayments.CurrencyID;
                        Com.Parameters["@ExchangeRate"].Value = ObjCVarSL_VoucherPayments.ExchangeRate;
                        Com.Parameters["@Amount"].Value = ObjCVarSL_VoucherPayments.Amount;
                        Com.Parameters["@Notes"].Value = ObjCVarSL_VoucherPayments.Notes;
                        Com.Parameters["@ChequeNo"].Value = ObjCVarSL_VoucherPayments.ChequeNo;
                        Com.Parameters["@ChequeDate"].Value = ObjCVarSL_VoucherPayments.ChequeDate;
                        Com.Parameters["@VoucherType"].Value = ObjCVarSL_VoucherPayments.VoucherType;
                        Com.Parameters["@IsCheque"].Value = ObjCVarSL_VoucherPayments.IsCheque;
                        Com.Parameters["@TaxID"].Value = ObjCVarSL_VoucherPayments.TaxID;
                        Com.Parameters["@TaxValue"].Value = ObjCVarSL_VoucherPayments.TaxValue;
                        Com.Parameters["@TaxSign"].Value = ObjCVarSL_VoucherPayments.TaxSign;
                        Com.Parameters["@TaxID2"].Value = ObjCVarSL_VoucherPayments.TaxID2;
                        Com.Parameters["@TaxValue2"].Value = ObjCVarSL_VoucherPayments.TaxValue2;
                        Com.Parameters["@TaxSign2"].Value = ObjCVarSL_VoucherPayments.TaxSign2;
                        Com.Parameters["@DiscountTaxID"].Value = ObjCVarSL_VoucherPayments.DiscountTaxID;
                        Com.Parameters["@DiscountTaxValue"].Value = ObjCVarSL_VoucherPayments.DiscountTaxValue;
                        Com.Parameters["@DiscountTaxID2"].Value = ObjCVarSL_VoucherPayments.DiscountTaxID2;
                        Com.Parameters["@DiscountTaxValue2"].Value = ObjCVarSL_VoucherPayments.DiscountTaxValue2;
                        Com.Parameters["@VoucherID"].Value = ObjCVarSL_VoucherPayments.VoucherID;
                        Com.Parameters["@PaymentID"].Value = ObjCVarSL_VoucherPayments.PaymentID;
                        // EndTrans(Com, Con);
                        Com.ExecuteNonQuery();
                        if (ObjCVarSL_VoucherPayments.ID == 0)
                        {
                            ObjCVarSL_VoucherPayments.ID = Convert.ToInt64(Com.Parameters["@ID"].Value);
                        }
                        ObjCVarSL_VoucherPayments.mIsChanges = false;
                    }
                }
            }
            catch (Exception ex)
    ...
    [Serializable]
    public class CPKSL_PaymentInvoices
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarSL_PaymentInvoices : CPKSL_PaymentInvoices
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CSL_PaymentInvoices
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarSL_PaymentInvoices> lstCVarSL_PaymentInvoices = new List<CVarSL_PaymentInvoices>();
        public List<CPKSL_PaymentInvoices> lstDeletedCPKSL_PaymentInvoices = new List<CPKSL_PaymentInvoices>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            SqlCommand Com;
            SqlDataReader dr;
            lstCVarSL_PaymentInvoices.Clear();
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarSL_PaymentInvoices ObjCVarSL_PaymentInvoices = new CVarSL_PaymentInvoices();
                        ObjCVarSL_PaymentInvoices.ID = Convert.ToInt64(dr["ID"].ToString());
                        ObjCVarSL_PaymentInvoices.mInvoiceID = Convert.ToInt64(dr["InvoiceID"].ToString());
                        ObjCVarSL_PaymentInvoices.mPaymentID = Convert.ToInt64(dr["PaymentID"].ToString());
                        ObjCVarSL_PaymentInvoices.mPaidAmount = Convert.ToDecimal(dr["PaidAmount"].ToString());
                        lstCVarSL_PaymentInvoices.Add(ObjCVarSL_PaymentInvoices);
                    }
                }
                catch (Exception ex)
                {
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKSL_PaymentInvoices> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKSL_PaymentInvoices ObjCPKSL_PaymentInvoices in DeleteList)
                {
                    BeginTrans(Com, Con);
                    Com.Parameters[0].Value = Convert.ToInt64(ObjCPKSL_PaymentInvoices.ID);
                    EndTrans(Com, Con);
                }
            }
            catch (Exception ex)
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarSL_PaymentInvoices> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnection.GlobalCom;
            try
            {
                ...
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarSL_PaymentInvoices ObjCVarSL_PaymentInvoices in SaveList)
                {
                    if (ObjCVarSL_PaymentInvoices.mIsChanges == true)
                    {
                        if (ObjCVarSL_PaymentInvoices.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemPaymentInvoices";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarSL_PaymentInvoices.ID != 0)
                        {
                        ...
                        if (ObjCVarSL_PaymentInvoices.ID != 0)
                        {
                            Com.Parameters["@ID"].Value = ObjCVarSL_PaymentInvoices.ID;
                        }
                        Com.Parameters["@InvoiceID"].Value = ObjCVarSL_PaymentInvoices.InvoiceID;
                        Com.Parameters["@PaymentID"].Value = ObjCVarSL_PaymentInvoices.PaymentID;
                        Com.Parameters["@PaidAmount"].Value = ObjCVarSL_PaymentInvoices.PaidAmount;
                        Com.ExecuteNonQuery();
                        if (ObjCVarSL_PaymentInvoices.ID == 0)
                        {
                            ObjCVarSL_PaymentInvoices.ID = Convert.ToInt64(Com.Parameters["@ID"].Value);
                        }
                        ObjCVarSL_PaymentInvoices.mIsChanges = false;
                    }
                }
            }
            catch (Exception ex)
    ...
    [Serializable]
    public class CPKSL_PaymentDbtCrdtNotes
    {
        #region "variables"
        private Int64 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarSL_PaymentDbtCrdtNotes : CPKSL_PaymentDbtCrdtNotes
    {
        #region "variables"
        internal Boolean mIsChanges = false;
    ...
    public partial class CSL_PaymentDbtCrdtNotes
    {
        #region "variables"
        /*If "App.Config" isnot exist add it to your Application
		Add this code after <Configuration> tag
		...
		where ".........." is connection string to database server*/
        private SqlTransaction tr;
        public List<CVarSL_PaymentDbtCrdtNotes> lstCVarSL_PaymentDbtCrdtNotes = new List<CVarSL_PaymentDbtCrdtNotes>();
        public List<CPKSL_PaymentDbtCrdtNotes> lstDeletedCPKSL_PaymentDbtCrdtNotes = new List<CPKSL_PaymentDbtCrdtNotes>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            SqlCommand Com;
            SqlDataReader dr;
            lstCVarSL_PaymentDbtCrdtNotes.Clear();
            ...
            try
            {
                ...
                {
                    Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                    Com.CommandText = "[dbo].GetListSL_PaymentDbtCrdtNotes";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemSL_PaymentDbtCrdtNotes";
                    Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                    Com.Parameters[0].Value = Convert.ToInt64(Param);
                }
                Com.Transaction = tr;
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarSL_PaymentDbtCrdtNotes ObjCVarSL_PaymentDbtCrdtNotes = new CVarSL_PaymentDbtCrdtNotes();
                        ObjCVarSL_PaymentDbtCrdtNotes.ID = Convert.ToInt64(dr["ID"].ToString());
                        ObjCVarSL_PaymentDbtCrdtNotes.mDbtCrdtNotesID = Convert.ToDecimal(dr["DbtCrdtNotesID"].ToString());
                        ObjCVarSL_PaymentDbtCrdtNotes.mPaymentID = Convert.ToInt64(dr["PaymentID"].ToString());
                        ObjCVarSL_PaymentDbtCrdtNotes.mPaidAmount = Convert.ToDecimal(dr["PaidAmount"].ToString());
                        lstCVarSL_PaymentDbtCrdtNotes.Add(ObjCVarSL_PaymentDbtCrdtNotes);
                    }
                }
                catch (Exception ex)
                {
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                Com.Parameters.Add(new SqlParameter("@OrderBy", SqlDbType.VarChar));
                Com.CommandText = "[dbo].GetListPagingSL_PaymentDbtCrdtNotes";
                Com.Parameters[0].Value = PageSize;
                Com.Parameters[1].Value = PageNumber;
                Com.Parameters[2].Value = WhereClause;
                Com.Parameters[3].Value = OrderBy;
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListSL_PaymentDbtCrdtNotes";
                else
                    Com.CommandText = "[dbo].UpdateListSL_PaymentDbtCrdtNotes";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
                Com.Parameters[0].Value = WhereClause;
                EndTrans(Com, Con);
        ...
        #endregion
        #region "Delete Methods"
        public Exception DeleteItem(List<CPKSL_PaymentDbtCrdtNotes> DeleteList)
        {
            ...
            try
            {
                Con.Open();
                Com = new SqlCommand();
                Com.CommandText = "[dbo].DeleteItemSL_PaymentDbtCrdtNotes";
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKSL_PaymentDbtCrdtNotes ObjCPKSL_PaymentDbtCrdtNotes in DeleteList)
                {
                    BeginTrans(Com, Con);
                    Com.Parameters[0].Value = Convert.ToInt64(ObjCPKSL_PaymentDbtCrdtNotes.ID);
                    EndTrans(Com, Con);
                }
            }
            catch (Exception ex)
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarSL_PaymentDbtCrdtNotes> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;// = GlobalConnection.GlobalCom;
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@PaidAmount", SqlDbType.Decimal));
                SqlParameter paraID = Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Default, null));
                foreach (CVarSL_PaymentDbtCrdtNotes ObjCVarSL_PaymentDbtCrdtNotes in SaveList)
                {
                    if (ObjCVarSL_PaymentDbtCrdtNotes.mIsChanges == true)
                    {
                        if (ObjCVarSL_PaymentDbtCrdtNotes.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemSL_PaymentDbtCrdtNotes";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarSL_PaymentDbtCrdtNotes.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemSL_PaymentDbtCrdtNotes";
                            paraID.Direction = ParameterDirection.Input;
                        }
                        // BeginTrans(Com, Con);
                        if (ObjCVarSL_PaymentDbtCrdtNotes.ID != 0)
                        {
                            Com.Parameters["@ID"].Value = ObjCVarSL_PaymentDbtCrdtNotes.ID;
                        }
                        Com.Parameters["@DbtCrdtNotesID"].Value = ObjCVarSL_PaymentDbtCrdtNotes.DbtCrdtNotesID;
                        Com.Parameters["@PaymentID"].Value = ObjCVarSL_PaymentDbtCrdtNotes.PaymentID;
                        Com.Parameters["@PaidAmount"].Value = ObjCVarSL_PaymentDbtCrdtNotes.PaidAmount;
                        Com.ExecuteNonQuery();
                        if (ObjCVarSL_PaymentDbtCrdtNotes.ID == 0)
                        {
                            ObjCVarSL_PaymentDbtCrdtNotes.ID = Convert.ToInt64(Com.Parameters["@ID"].Value);
                        }
                        ObjCVarSL_PaymentDbtCrdtNotes.mIsChanges = false;
                    }
                }
            }
            catch (Exception ex)
    ...
    public partial class CVarSL_Payments : CPKSL_Payments
    {
        #region "variables"
        internal Boolean mIsChanges = false;
        internal String mCode;
    ...
    public partial class CA_VoucherHeader
    {
        ...
        public Exception SaveMethod(List<CVarA_VoucherHeader> SaveList)
        {
            ...
            try
            {
                ...
                //Com.Parameters.Add(new SqlParameter("@DiscountTaxID2", SqlDbType.Int));
                //Com.Parameters.Add(new SqlParameter("@DiscountTaxValue2", SqlDbType.Decimal));
                //Com.Parameters.Add(new SqlParameter("@IsCustody", SqlDbType.Bit));
                ...
                foreach (CVarA_VoucherHeader ObjCVarA_Voucher in SaveList)
                {
                    if (ObjCVarA_Voucher.mIsChanges == true)
                    {
                        ...
                        //Com.Parameters["@DiscountTaxID"].Value = ObjCVarA_Voucher.DiscountTaxID;
                        //Com.Parameters["@DiscountTaxValue"].Value = ObjCVarA_Voucher.DiscountTaxValue;
                        //Com.Parameters["@DiscountTaxID2"].Value = ObjCVarA_Voucher.DiscountTaxID2;
                        //Com.Parameters["@DiscountTaxValue2"].Value = ObjCVarA_Voucher.DiscountTaxValue2;
                        //Com.Parameters["@IsCustody"].Value = ObjCVarA_Voucher.IsCustody;
    ...
    public class CPaymentsCustomizedDBCall
    {
        ...
        public string A_ChequeVoucher_GetCodeByBank_NEW(string pStoredProcedureName, DateTime pDate, Int32 pBankID, bool pIsLiner)
        {
            Exception Exp = null;
            ...
            try
            {
                ...
                Com.Parameters[0].Value = pDate;
                Com.Parameters[1].Value = pBankID;
                Com.Parameters[2].Value = pIsLiner;
