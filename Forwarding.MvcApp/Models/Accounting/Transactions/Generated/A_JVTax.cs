...
namespace Forwarding.MvcApp.Models.Accounting.Transactions.Generated
{
    ...
    [Serializable]
    public partial class CVarA_JVTax : CPKA_JVTax
    {
        #region "variables"
    ...
    public partial class CA_JVTax
    {
        ...
        public List<CVarA_JVTax> lstCVarA_JVTax = new List<CVarA_JVTax>();
        public List<CPKA_JVTax> lstDeletedCPKA_JVTax = new List<CPKA_JVTax>();
        #endregion
            ...
            try
            {
                ...
                try
                {
                    while (dr.Read())
                    {
                        ...
                        ObjCVarA_JVTax.ID = Convert.ToInt64(dr["ID"].ToString());
                        ObjCVarA_JVTax.mJVNo = Convert.ToString(dr["JVNo"].ToString());
                        ObjCVarA_JVTax.mJVDate = Convert.ToDateTime(dr["JVDate"].ToString());
                        ObjCVarA_JVTax.mTotalDebit = Convert.ToDecimal(dr["TotalDebit"].ToString());
                        ObjCVarA_JVTax.mTotalCredit = Convert.ToDecimal(dr["TotalCredit"].ToString());
                        ObjCVarA_JVTax.mJournal_ID = Convert.ToInt32(dr["Journal_ID"].ToString());
                        ObjCVarA_JVTax.mJVType_ID = Convert.ToInt32(dr["JVType_ID"].ToString());
                        ObjCVarA_JVTax.mReceiptNo = Convert.ToString(dr["ReceiptNo"].ToString());
                        ObjCVarA_JVTax.mRemarksHeader = Convert.ToString(dr["RemarksHeader"].ToString());
                        ObjCVarA_JVTax.mDeleted = Convert.ToBoolean(dr["Deleted"].ToString());
                        ObjCVarA_JVTax.mPosted = Convert.ToBoolean(dr["Posted"].ToString());
                        ObjCVarA_JVTax.mUser_ID = Convert.ToInt32(dr["User_ID"].ToString());
                        ObjCVarA_JVTax.mIsSysJv = Convert.ToBoolean(dr["IsSysJv"].ToString());
                        ObjCVarA_JVTax.mTransType_ID = Convert.ToInt32(dr["TransType_ID"].ToString());
                        lstCVarA_JVTax.Add(ObjCVarA_JVTax);
                    }
                }
                catch (Exception ex)
                {
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListA_JVTax";
                else
                    Com.CommandText = "[dbo].UpdateListA_JVTax";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKA_JVTax> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.BigInt));
                foreach (CPKA_JVTax ObjCPKA_JVTax in DeleteList)
                {
                    BeginTrans(Com, Con);
                    Com.Parameters[0].Value = Convert.ToInt64(ObjCPKA_JVTax.ID);
                    EndTrans(Com, Con);
                }
            }
            catch (Exception ex)
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_JVTax> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarA_JVTax ObjCVarA_JVTax in SaveList)
                {
                    if (ObjCVarA_JVTax.mIsChanges == true)
                    {
                        if (ObjCVarA_JVTax.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemA_JVTax";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarA_JVTax.ID != 0)
                        {
                        ...
                        if (ObjCVarA_JVTax.ID != 0)
                        {
                            Com.Parameters["@ID"].Value = ObjCVarA_JVTax.ID;
                        }
                        Com.Parameters["@JVNo"].Value = ObjCVarA_JVTax.JVNo;
                        Com.Parameters["@JVDate"].Value = ObjCVarA_JVTax.JVDate;
                        Com.Parameters["@TotalDebit"].Value = ObjCVarA_JVTax.TotalDebit;
                        Com.Parameters["@TotalCredit"].Value = ObjCVarA_JVTax.TotalCredit;
                        Com.Parameters["@Journal_ID"].Value = ObjCVarA_JVTax.Journal_ID;
                        Com.Parameters["@JVType_ID"].Value = ObjCVarA_JVTax.JVType_ID;
                        Com.Parameters["@ReceiptNo"].Value = ObjCVarA_JVTax.ReceiptNo;
                        Com.Parameters["@RemarksHeader"].Value = ObjCVarA_JVTax.RemarksHeader;
                        Com.Parameters["@Deleted"].Value = ObjCVarA_JVTax.Deleted;
                        Com.Parameters["@Posted"].Value = ObjCVarA_JVTax.Posted;
                        Com.Parameters["@User_ID"].Value = ObjCVarA_JVTax.User_ID;
                        Com.Parameters["@IsSysJv"].Value = ObjCVarA_JVTax.IsSysJv;
                        Com.Parameters["@TransType_ID"].Value = ObjCVarA_JVTax.TransType_ID;
                        EndTrans(Com, Con);
                        if (ObjCVarA_JVTax.ID == 0)
                        {
                            ObjCVarA_JVTax.ID = Convert.ToInt64(Com.Parameters["@ID"].Value);
                        }
                        ObjCVarA_JVTax.mIsChanges = false;
                    }
                }
            }
            catch (Exception ex)
        ...
        public Exception A_JVSaveMethod(List<CVarA_JVTax> SaveList)
        {
            Exception Exp = null;
            //SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
