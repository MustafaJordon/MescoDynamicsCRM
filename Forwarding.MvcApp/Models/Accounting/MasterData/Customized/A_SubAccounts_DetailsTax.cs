...
{
    [Serializable]
    public class CPKA_SubAccounts_DetailsTAX
    {
        #region "variables"
    ...
    [Serializable]
    public partial class CVarA_SubAccounts_DetailsTAX : CPKA_SubAccounts_DetailsTAX
    {
        #region "variables"
    ...
    public partial class CA_SubAccounts_DetailsTAX
    {
        #region "variables"
        ...
        public List<CVarA_SubAccounts_DetailsTAX> lstCVarA_SubAccounts_Details = new List<CVarA_SubAccounts_DetailsTAX>();
        public List<CPKA_SubAccounts_DetailsTAX> lstDeletedCPKA_SubAccounts_Details = new List<CPKA_SubAccounts_DetailsTAX>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarA_SubAccounts_DetailsTAX ObjCVarA_SubAccounts_Details = new CVarA_SubAccounts_DetailsTAX();
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.CommandText = "[dbo].GetListPagingA_SubAccounts_DetailsTax";
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListA_SubAccounts_DetailsTax";
                else
                    Com.CommandText = "[dbo].UpdateListA_SubAccounts_DetailsTax";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKA_SubAccounts_DetailsTAX> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@SubAccount_ID", SqlDbType.Int));
                Com.Parameters.Add(new SqlParameter("@Account_ID", SqlDbType.Int));
                foreach (CPKA_SubAccounts_DetailsTAX ObjCPKA_SubAccounts_Details in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_SubAccounts_DetailsTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarA_SubAccounts_DetailsTAX ObjCVarA_SubAccounts_Details in SaveList)
                {
