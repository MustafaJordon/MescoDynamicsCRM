...
namespace Forwarding.MvcApp.Models.Accounting.MasterData.Customized
{
    ...
    public partial class FillClientAndSupplierList
    {
        #region "variables"
        ...
        public Exception GetList(string WhereClause, string WhereClause2)
        {
            return DataFill(WhereClause, WhereClause2, true);
        }
        public Exception GetListPaging(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotalRecords)
        {
            return DataFill(PageSize, PageNumber, WhereClause, OrderBy, out TotalRecords);
        }
        private Exception DataFill(string Param, string Param2, Boolean IsList)
        {
            Exception Exp = null;
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.Parameters.Add(new SqlParameter("@Account_ID", SqlDbType.VarChar));

                    Com.CommandText = "[dbo].FillClientAndSupplierList";
                    Com.Parameters[0].Value = Param;
                    Com.Parameters[1].Value = Param2;
