...
{
    [Serializable]
    public class CPKA_SubAccountsTAX
    {
        #region "variables"
        private Int32 mID;
        #endregion
    ...
    [Serializable]
    public partial class CVarA_SubAccountsTAX : CPKA_SubAccountsTAX
    {
        #region "variables"
    ...
    public partial class CA_SubAccountsTAX
    {
        #region "variables"
        ...
        public List<CVarA_SubAccountsTAX> lstCVarA_SubAccounts = new List<CVarA_SubAccountsTAX>();
        public List<CPKA_SubAccountsTAX> lstDeletedCPKA_SubAccounts = new List<CPKA_SubAccountsTAX>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListA_SubAccountsTax";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemA_SubAccountsTax";
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarA_SubAccountsTAX ObjCVarA_SubAccounts = new CVarA_SubAccountsTAX();
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.CommandText = "[dbo].GetListPagingA_SubAccountsTax";
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListA_SubAccountsTAX";
                else
                    Com.CommandText = "[dbo].UpdateListA_SubAccountsTAX";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKA_SubAccountsTAX> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                foreach (CPKA_SubAccountsTAX ObjCPKA_SubAccounts in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_SubAccountsTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarA_SubAccountsTAX ObjCVarA_SubAccounts in SaveList)
                {
                    if (ObjCVarA_SubAccounts.mIsChanges == true)
                    {
                        if (ObjCVarA_SubAccounts.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemA_SubAccountsTAX";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarA_SubAccounts.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemA_SubAccountsTAX";
        ...
        public Exception SaveMethodCHMTAX(List<CVarA_SubAccountsTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
