...
namespace Forwarding.MvcApp.Models.Accounting.MasterData.Customized
{
    ...
    [Serializable]
    public partial class CVarCustomersTAX : CPKCustomersTAX
    {
        #region "variables"
    ...
    public partial class CCustomersTAX
    {
        #region "variables"
        ...
        public List<CVarCustomersTAX> lstCVarCustomersTAX = new List<CVarCustomersTAX>();
        public List<CPKCustomersTAX> lstDeletedCPKCustomersTAX = new List<CPKCustomersTAX>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListCustomersTAX";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemCustomersTAX";
                ...
                try
                {
                    ...
                    {
                        /*Start DataReader*/
                        CVarCustomersTAX ObjCVarCustomers = new CVarCustomersTAX();
                        ...
                        lstCVarCustomersTAX.Add(ObjCVarCustomers);
                    }
                }
                catch (Exception ex)
                {
        ...
        public Exception DeleteItem(List<CPKCustomersTAX> DeleteList)
        {
            ...
            try
            {
                Con.Open();
                Com = new SqlCommand();
                Com.CommandText = "[dbo].DeleteItemCustomersTAX";
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                foreach (CPKCustomersTAX ObjCPKCustomers in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarCustomersTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarCustomersTAX ObjCVarCustomers in SaveList)
                {
        ...
        public Exception SaveMethodCHMTAX(List<CVarCustomersTAX> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
