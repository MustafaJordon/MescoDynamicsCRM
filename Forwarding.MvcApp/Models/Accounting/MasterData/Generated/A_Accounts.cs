...
namespace Forwarding.MvcApp.Models.Accounting.MasterData.Generated
{
    ...
    [Serializable]
    public partial class CVarA_Accounts : CPKA_Accounts
    {
        #region "variables"
    ...
    public partial class CA_Accounts
    {
        #region "variables"
        ...
        public List<CVarA_Accounts> lstCVarA_Accounts = new List<CVarA_Accounts>();
        public List<CPKA_Accounts> lstDeletedCPKA_Accounts = new List<CPKA_Accounts>();
        #endregion
        ...
        private Exception DataFill(string Param, Boolean IsList)
        {
            ...
            try
            {
                ...
                if (IsList == true)
                {
                    ...
                    Com.CommandText = "[dbo].GetListA_Accounts";
                    Com.Parameters[0].Value = Param;
                }
                else
                {
                    Com.CommandText = "[dbo].GetItemA_Accounts";
        ...
        private Exception DataFill(Int32 PageSize, Int32 PageNumber, string WhereClause, string OrderBy, out Int32 TotRecs)
        {
            ...
            try
            {
                ...
                Com.CommandText = "[dbo].GetListPagingA_Accounts";
        ...
        private Exception SetList(string WhereClause, Boolean IsDelete)
        {
            ...
            try
            {
                ...
                Com = new SqlCommand();
                if (IsDelete == true)
                    Com.CommandText = "[dbo].DeleteListA_Accounts";
                else
                    Com.CommandText = "[dbo].UpdateListA_Accounts";
                Com.Parameters.Add(new SqlParameter("@WhereClause", SqlDbType.NVarChar));
                BeginTrans(Com, Con);
        ...
        public Exception DeleteItem(List<CPKA_Accounts> DeleteList)
        {
            ...
            try
            {
                ...
                Com.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                foreach (CPKA_Accounts ObjCPKA_Accounts in DeleteList)
                {
                    BeginTrans(Com, Con);
        ...
        #endregion
        #region "Save Methods"
        public Exception SaveMethod(List<CVarA_Accounts> SaveList)
        {
            Exception Exp = null;
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
            SqlCommand Com;
            try
            {
                ...
                foreach (CVarA_Accounts ObjCVarA_Accounts in SaveList)
                {
                    if (ObjCVarA_Accounts.mIsChanges == true)
                    {
                        if (ObjCVarA_Accounts.ID == 0)
                        {
                            Com.CommandText = "[dbo].InsertItemA_Accounts";
                            paraID.Direction = ParameterDirection.Output;
                        }
                        else if (ObjCVarA_Accounts.ID != 0)
                        {
                            Com.CommandText = "[dbo].UpdateItemA_Accounts";
