...
namespace Forwarding.MvcApp.Controllers.ReceiptsAndPayments.YardLink
{
    public class YardLinkClientsController : ApiController
    {
        [HttpGet, HttpPost]
        public object[] LoadWithPagingWithWhereClauseAndOrderByWithObjectArrayReturned(bool pIsLoadArrayOfObjects, string pLanguage, Int32 pPageNumber, Int32 pPageSize, string pWhereClause, string pOrderBy)
        {
            ...
            CvwSL_ClientToLinkYard objCvwSL_ClientToLink = new CvwSL_ClientToLinkYard();
            objCvwSL_ClientToLink.GetListPaging(pPageSize, pPageNumber, pWhereClause, pOrderBy, out _RowCount);

            return new object[] {
                new JavaScriptSerializer().Serialize(objCvwSL_ClientToLink.lstCVarvwSL_ClientToLinkYard)
                , _RowCount
        ...
        public object Save(string pSelectedIDs, Int32 pClientGroupID)
        {
            ...
            for (int i = 0; i < ArrSelectedIDs.Length; i++)
            {
                ...
                CSL_YardLinkClients objCVarSL_ShipLinkClientsCheck = new CSL_YardLinkClients();
                objCVarSL_ShipLinkClientsCheck.GetList("WHERE YardClientID=" + ArrSelectedIDs[i]);
                if (objCVarSL_ShipLinkClientsCheck.lstCVarSL_YardLinkClients.Count ==0 )
                {
                    ...
                    objCVarSL_Clients.LocalName = objCClient.lstCVarvwClientsYard[0].ArName == "" ? objCClient.lstCVarvwClientsYard[0].EnName : objCClient.lstCVarvwClientsYard[0].ArName;
                    objCVarSL_Clients.Name = objCClient.lstCVarvwClientsYard[0].EnName == "" ? objCClient.lstCVarvwClientsYard[0].ArName : objCClient.lstCVarvwClientsYard[0].EnName;
                    objCVarSL_Clients.SubAccountGroupID = pClientGroupID;
                    objCVarSL_Clients.Address = objCClient.lstCVarvwClientsYard[0].AddressInfo;
                    ...
                    objCVarSL_Clients.PhonesAndFaxes = objCClient.lstCVarvwClientsYard[0].Mobile;
                    objCVarSL_Clients.Email = objCClient.lstCVarvwClientsYard[0].EMail;
                    objCVarSL_Clients.Notes = objCClient.lstCVarvwClientsYard[0].Remarks;
                    ...
                    objCVarSL_Clients.VATNumber = objCClient.lstCVarvwClientsYard[0].TaxNumber;
                    ...
                    if (checkException == null)
                    {
                        ...
                        objCVarA_SubAccounts.SubAccount_Name = objCClient.lstCVarvwClientsYard[0].ArName == "" ? objCClient.lstCVarvwClientsYard[0].EnName : objCClient.lstCVarvwClientsYard[0].ArName;
                        objCVarA_SubAccounts.SubAccount_EnName = objCClient.lstCVarvwClientsYard[0].EnName == "" ? objCClient.lstCVarvwClientsYard[0].ArName : objCClient.lstCVarvwClientsYard[0].EnName;
                        ...
                        if (checkException == null)
                        {
                            ...
                            //    #endregion Add SubAccountDetails if exist
                            //}
                            CVarSL_YardLinkClients objCVarSL_ShipLinkClients = new CVarSL_YardLinkClients();
                            objCVarSL_ShipLinkClients.YardClientID = objCClient.lstCVarvwClientsYard[0].ID;
                            objCVarSL_ShipLinkClients.ERPClientID = objCVarSL_Clients.ID;
                            objCVarSL_ShipLinkClients.SubAccountID = objCVarA_SubAccounts.ID;
                            CSL_YardLinkClients objCSL_ShipLinkClients = new CSL_YardLinkClients();
                            objCSL_ShipLinkClients.lstCVarSL_YardLinkClients.Add(objCVarSL_ShipLinkClients);
                            checkException = objCSL_ShipLinkClients.SaveMethod(objCSL_ShipLinkClients.lstCVarSL_YardLinkClients);
                            if (checkException == null)
                                _result = true;
                        }
