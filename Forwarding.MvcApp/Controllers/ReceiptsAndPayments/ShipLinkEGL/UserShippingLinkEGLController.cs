...
{
    public class UserShippingLinkEGLController : ApiController
    {
        [HttpGet, HttpPost]
        ...
        public bool Insert(Int32 pUserID, Int32 pUserDasID)
        {
            ...
            { //not unique
                ...
                objCCustomizedDBCall.SP_Trans_Log("SP_Trans_Log", WebSecurity.CurrentUserId, "Sec_User_DAS_LinkEGL", objCVarSec_User_DAS_Link.ID, "I");
            }
            return _result;
        }
        ...
        public bool Delete(String pIDs)//pSec_UserSafesIDs
        {
            ...
            foreach (var currentID in pIDs.Split(','))
            {
                ...
                {
                    CCustomizedDBCall objCCustomizedDBCall = new CCustomizedDBCall();
                    objCCustomizedDBCall.SP_Trans_Log("SP_Trans_Log", WebSecurity.CurrentUserId, "Sec_User_DAS_LinkEGL", Int32.Parse(currentID.Trim()), "D");
                }
