//using Shipping.MvcApp.Models.Accounting.MasterData.Generated;
//using Shipping.MvcApp.Models.Accounting.Reports.Customized;
//using Shipping.MvcApp.Models.Accounting.MasterData.Customized;

//using Shipping.MvcApp.Models.Sales.MasterData.Generated;

//using Shipping.MvcApp.Models.ReportViews;
...
namespace Shipping.MvcApp.Controllers.Purchasing.API_Reports
{
    public class PS_SupplierAgingReportController : ApiController
    {
        [HttpGet, HttpPost]
      ...
      bool pIsLoadArrayOfObjects, string pLanguage, Int32 pPageNumber, Int32 pPageSize, string pWhereClause, string pOrderBy)
        {
          ...
          //  objCSL_Clients.GetListClientAndSupplierAging(pWhereClause);
        ...
        public object[] FillSearchControls()
        {
          ...
          //  objCSL_Clients.GetListPaging(9999, 1, "WHERE 1=1", "Name, Code", out _RowCount);
           // objCSL_Clients.GetListClientAndSupplierAging("3");

           // objCvwMainA_Accounts.GetListClientAndSupplierAging("3");
        ...
        //        new JavaScriptSerializer().Serialize(objCvwRptHeaderDefaultTable.lstCVarvwRptHeaderDefaultTable[0]) //pDefaultsHeader = pData[0]
        //        , pCostCenter_IDs == "0" 
        ...
        //[HttpGet, HttpPost]
        //public object[] LoadRows(string pWhereClause)
        //{
        //    CvwGetListBillArrNotification objCvwGetListBillArrNotification = new CvwGetListBillArrNotification();
        //    objCvwGetListBillArrNotification.GetList(pWhereClause);

        //    return new object[]
        //    {
        //        new JavaScriptSerializer().Serialize(objCvwGetListBillArrNotification.lstCVarvwGetListBillArrNotification)
        //    };
        //}

        //[HttpGet, HttpPost]
        //public object[] GetPrintedData(string pWhereClausePrintedData, string pOrderBy, bool pIsLoadFreight)
        //{
        //    int _RowCount = 0;
        //    CvwRptHeaderDefaultTable objCvwRptHeaderDefaultTable = new CvwRptHeaderDefaultTable();
        //    objCvwRptHeaderDefaultTable.GetList("WHERE 1=1");

        //    CvwManifestHeader objCvwManifestHeader = new CvwManifestHeader();
        //    objCvwManifestHeader.GetListPaging(10000, 1, pWhereClausePrintedData, pOrderBy, out _RowCount);

        //    CvwManifestContainer objCvwManifestContainer = new CvwManifestContainer();
        //    objCvwManifestContainer.GetListPaging(10000, 1, pWhereClausePrintedData, pOrderBy, out _RowCount);

        //    CvwManifestFreight objCvwManifestFreight = new CvwManifestFreight();
        //    if (pIsLoadFreight)
        //        objCvwManifestFreight.GetListPaging(10000, 1, pWhereClausePrintedData, "FreightOrder", out _RowCount);

        //    return new object[] {
        //        new JavaScriptSerializer().Serialize(objCvwRptHeaderDefaultTable.lstCVarvwRptHeaderDefaultTable[0]) //pDefaultsHeader = pData[0]
        //        , new JavaScriptSerializer().Serialize(objCvwManifestHeader.lstCVarvwManifestHeader) //pManifestHeader = pData[1]
        //        , new JavaScriptSerializer().Serialize(objCvwManifestContainer.lstCVarvwManifestContainer) //pManifestContainer = pData[2]
        //        , new JavaScriptSerializer().Serialize(objCvwManifestFreight.lstCVarvwManifestFreight) //pManifestFreight = pData[3]
        //    };
        //}
    }
}
