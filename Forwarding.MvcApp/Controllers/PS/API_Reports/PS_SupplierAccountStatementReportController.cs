...
{
    public class PS_SupplierAccountStatementReportController : ApiController
    {
        [HttpGet, HttpPost]
      ...
      bool pIsLoadArrayOfObjects, string pLanguage, Int32 pPageNumber, Int32 pPageSize, string pWhereClause, string pWhereClause2, string pOrderBy)
        {
            ...
            if (pWhereClause2 == "-1")
            {
                objCSL_Clients.GetList("3", pWhereClause2);
            }
            else
            {
                objCSL_Clients.GetList("3", "," + pWhereClause2 + ",");
        ...
        public object[] FillSearchControls()
        {
            ...
            objCSL_Clients.GetList("3", "-1");

            objCvwMainA_Accounts.GetList("3");
