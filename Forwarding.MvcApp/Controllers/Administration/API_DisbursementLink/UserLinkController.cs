...
namespace Forwarding.MvcApp.Controllers.Administration.API_DisbursementLink
{
    public class UserLinkController : ApiController
    {
        [HttpGet, HttpPost]
        public object[] LoadWithPagingWithWhereClauseAndOrderByWithObjectArrayReturned(bool pIsLoadArrayOfObjects, string pLanguage, Int32 pPageNumber, Int32 pPageSize, string pWhereClause, string pOrderBy)
        {
            ...
            CDASUsers objDASUsers = new CDASUsers();
            ...
            return new object[] {
               ...
               , _RowCount
               , new JavaScriptSerializer().Serialize(objDASUsers.lstCVarDASUsers)
